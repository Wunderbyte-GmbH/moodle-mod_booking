 ...
 *
 * This is a child language of 'de' (parentlanguage = de). Only strings that differ
 * from the standard German pack are defined here; everything else is inherited from 'de'.
 * Gender-fair forms are written with a slash, e.g. "Nutzer/innen", "Trainer/in".
 *
 * @package     mod_booking
 * @category    string
...
$string['openbookingdetailinsametab_desc'] = 'In der Kursliste wird beim Klick auf den Titel der Buchungsoption die Detailansicht geöffnet. Wenn Sie diese Option anwählen, wir der/die Nutzer/in dabei direkt zu dieser Seite geleitet. Wird der Haken nicht gesetzt, öffnet sich die Detailansicht in einem neuen Tab.';
