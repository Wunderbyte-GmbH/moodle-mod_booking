...
$string['bookingticketheading_desc'] = 'Issue a personalised PDF ticket with a QR code when a booking succeeds, verify it at the door and invalidate it on cancellation. Requires tool_certificate and an active certificate template.';
$string['bookingticketon'] = 'Enable entry tickets';
$string['bookingticketon_desc'] = 'When enabled, a ticket certificate is issued from the master template below for every successful booking.';
$string['bookingticketsendmail'] = 'Send ticket by email';
$string['bookingticketsendmail_desc'] = 'Deliver the ticket PDF to the participant by email when it is issued.';
...
$string['bookingtickettemplate_desc'] = 'The single global tool_certificate template used for all entry tickets. Company branding is taken from the course image at render time, so one template serves all tenants.';
