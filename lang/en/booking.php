...
$string['evasyscategoryfield'] = 'User profile field for Evasys id';
$string['evasyscategoryfield_desc'] = 'Select a user profile field in which the Evasys id is stored for each user.';
