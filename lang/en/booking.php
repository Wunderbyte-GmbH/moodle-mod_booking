...
$string['slot_release_use_cancel'] = 'The last slot of a purchased booking cannot be cancelled here. Please use the cancel button of the booking, so that the refund is calculated correctly.';
