...
$string['teacherpagevisibilitymode_desc'] = 'Controls which hidden booking options a teacher can see on their own public teacher profile page. It does not apply when viewing other teachers\' pages. Only options where that teacher is assigned will be shown. This setting does not affect users with the \'canseeinvisibleoptions\' capability, who can always see all hidden options';
