...
$string['enrolself'] = 'Allow self enrolment';
$string['enrolselfdesc'] = 'By default, the course hosting the activity is not returned in course searches. Enable this option to allow enrolment and group membership in the host course.';
