...
$string['bocondcustomformdeleteinfoscheckbox'] = 'Checkbox to delete answers';
$string['bocondcustomformdeleteinfoscheckboxtext'] = 'Would you like the information provided here to be deleted after the event is over?';
