...
$string['sendmessagesforinvisibleoptions_desc'] = 'Enable message sending for booking options that are invisible except to persons with the corresponding capability?';
