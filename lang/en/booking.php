...
$string['completionchanged'] = 'Change of Completion';
$string['completionchangedhistory'] = 'The Completion was changed from "{$a->completionold}" zu "{$a->completionnew}" geändert';
