...
$string['bookingtimerelativeautoapply'] = '⤷ Apply booking period automatically to new booking options';
$string['bookingtimerelativeautoapply_desc'] = 'If enabled, the booking opening and closing period checkboxes are pre-checked when creating a new booking option.';
