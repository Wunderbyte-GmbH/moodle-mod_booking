...
that you either created yourself or are assigned to as a teacher)';
$string['booking:managebulkcheck'] = 'Manage the rule mails parked by the bulk send check';
...
$string['bookinganswerremovedfromwaitinglist'] = 'Removed from waiting list after offer expired';
$string['bookinganswerremovedfromwaitinglistdesc'] = 'The user with ID {$a->relateduserid} was removed from the waiting list of the booking option with ID {$a->objectid} because their offer expired.';
...
$string['bulkcheckactive'] = 'Check this rule for bulk sending';
$string['bulkcheckactive_help'] = 'Postpone the mails of this rule and stop them if an unusual number of them is about to go out at once. The mails are then parked until someone sends or deletes them. How long the sending is postponed, and over how long the sends are counted, is the same for every rule and is set in the plugin settings.';
$string['bulkcheckactive_label'] = 'Stop the mails of this rule when too many go out at once';
$string['bulkcheckblockedbody'] = 'The rule "{$a->rule}" was about to send {$a->count} mails. That is more than the configured limit of {$a->limit} per {$a->period}, so none of them were sent. They are parked and wait for a decision: {$a->link}';
$string['bulkcheckblockedsubject'] = 'Bulk send blocked: {$a->rule}';
$string['bulkcheckdelay'] = 'Bulk send check: delay';
$string['bulkcheckdelay_desc'] = 'How long a checked mail is held back so that the rest of its burst can pile up before anything is sent. A booking rule queues its whole burst in one go, so this only has to cover that plus one cron run: two minutes suit most sites. Raise it on a site where one rule can mail more than a few thousand people at once. A burst that takes longer than this to queue, or a delay of zero, lets at most the limit through before the rest is stopped.';
$string['bulkcheckdeletedoption'] = 'deleted booking option #{$a}';
$string['bulkcheckdeletedrule'] = 'deleted rule #{$a}';
$string['bulkcheckdismissall'] = 'Delete all {$a}';
$string['bulkcheckdismissallbody'] = 'Every parked mail of this list is deleted and never sent - not only the ones on screen. The filter and the search are ignored.';
$string['bulkcheckdismissbody'] = 'These mails will never be sent: <br> "{$a->data}"';
$string['bulkcheckdismissed'] = '{$a} mail(s) were given up on. They are never sent.';
$string['bulkcheckdismissselected'] = 'Delete selected';
$string['bulkcheckdismisssubmit'] = 'Delete them';
$string['bulkcheckdismisstitle'] = 'Give up on these parked mails?';
$string['bulkcheckduecolumn'] = 'Due';
$string['bulkcheckemailcolumn'] = 'E-mail';
$string['bulkcheckenabled'] = 'Check rule mails for bulk sending';
$string['bulkcheckenabled_desc'] = 'Postpone the mails of booking rules that are configured for the bulk send check and stop them when an unusual number of them is about to go out at once. The stopped mails wait for a manual release and the configured users are informed. Only mails sent by booking rules are checked; messages sent by hand, poll links and waiting list mails are not. While this is switched off all rule mails are sent straight away.';
$string['bulkchecklimit'] = 'Sends allowed per period';
$string['bulkchecknotifyusers'] = 'Who is told about a blocked bulk send';
$string['bulkchecknotifyusers_desc'] = 'These users get the alert when a burst is blocked, and the daily reminder while mails stay parked. Leave empty to tell all site administrators.';
$string['bulkcheckoldestcolumn'] = 'Waiting';
$string['bulkcheckoptioncolumn'] = 'Booking option';
$string['bulkcheckparked'] = 'Parked rule mails';
$string['bulkcheckparkeddescription'] = 'Send or delete the mails that the bulk send check stopped';
$string['bulkcheckparkedintro'] = 'These mails were stopped because too many of them were about to go out at once. Tick the ones that should go out after all and send them, or deal with the whole list in one go. A released mail is checked again before it is sent: if its rule was changed or deleted in the meantime, it is not sent.';
$string['bulkcheckparkedwarning'] = '{$a} mail(s) are parked by the bulk send check and wait for a decision.';
$string['bulkcheckperiod'] = 'Bulk send check: period';
$string['bulkcheckperiod_desc'] = 'The stretch of time the sends of one rule are counted over. Go past the limit within it and the whole burst is parked instead of sent.';
$string['bulkcheckreleaseall'] = 'Send all {$a}';
$string['bulkcheckreleaseallbody'] = 'Every parked mail of this list is sent - not only the ones on screen. The filter and the search are ignored. Mails whose rule was changed or deleted in the meantime are not sent.';
$string['bulkcheckreleasebody'] = 'These mails will be sent: <br> "{$a->data}"';
$string['bulkcheckreleasequeued'] = '{$a} mail(s) queued. They go out with the next cron run.';
$string['bulkcheckreleasesubmit'] = 'Send them';
$string['bulkcheckreleasetitle'] = 'Send these parked mails after all?';
$string['bulkcheckreminderbody'] = '{$a->total} mail(s) in {$a->bursts} burst(s) are still parked and have not been sent. Release them if they should go out after all, or delete them to stop this reminder.';
$string['bulkcheckreminderline'] = '{$a->rule} (rule {$a->ruleid}): {$a->parked} parked, waiting {$a->waiting}';
$string['bulkcheckremindersubject'] = '{$a->total} rule mail(s) still parked';
$string['bulkcheckrulecolumn'] = 'Rule';
$string['bulkcheckscopedintro'] = 'Only the parked mails of the rule "{$a}" are listed, and the two buttons that act on everything act on that rule alone.';
$string['bulkchecksendselected'] = 'Send selected';
$string['bulkcheckshowallrules'] = 'Show every parked mail';
$string['bulkcheckusercolumn'] = 'Recipient';
$string['bulkcheckwaiting'] = 'for {$a}';
...
$string['cachedef_bulkcheckconfig'] = 'Bulk send check: configuration (cache)';
$string['cachedef_bulkcheckmails'] = 'Bulk send check: parked mails (cache)';
...
$string['eventbulkcheckblocked'] = 'Rule mail parked by the bulk send check';
$string['eventbulkcheckdismissed'] = 'Parked rule mails deleted';
$string['eventbulkcheckreleased'] = 'Parked rule mails released';
...
$string['messageprovider:bulkchecknotification'] = 'Bulk send check alert';
...
$string['privacy:metadata:booking_bulk_check'] = 'Queued and parked rule mails of the bulk send check';
$string['privacy:metadata:booking_bulk_check:optionid'] = 'The booking option the mail is about';
$string['privacy:metadata:booking_bulk_check:ruleid'] = 'The booking rule that queued the mail';
$string['privacy:metadata:booking_bulk_check:scheduledtime'] = 'When the mail is due to go out';
$string['privacy:metadata:booking_bulk_check:status'] = 'Whether the mail is queued, parked, released or sent';
$string['privacy:metadata:booking_bulk_check:userid'] = 'The recipient of the mail';
...
$string['privacy:metadata:bookingwaitlistdeclines'] = 'Lockout ledger for users who declined or let a waiting list offer expire';
$string['privacy:metadata:bookingwaitlistdeclines:optionid'] = 'ID of the booking option';
$string['privacy:metadata:bookingwaitlistdeclines:reason'] = 'Reason for the lockout (declined or expired)';
$string['privacy:metadata:bookingwaitlistdeclines:timecreated'] = 'Time the lockout was created';
$string['privacy:metadata:bookingwaitlistdeclines:userid'] = 'ID of the user';
$string['privacy:metadata:bookingwaitlistoffers'] = 'Waiting list offers and decisions per user';
$string['privacy:metadata:bookingwaitlistoffers:expiresat'] = 'Time the offer expires';
$string['privacy:metadata:bookingwaitlistoffers:offeredat'] = 'Time the offer was made';
$string['privacy:metadata:bookingwaitlistoffers:optionid'] = 'ID of the booking option';
$string['privacy:metadata:bookingwaitlistoffers:status'] = 'Status of the offer';
$string['privacy:metadata:bookingwaitlistoffers:timecreated'] = 'Time the offer record was created';
$string['privacy:metadata:bookingwaitlistoffers:userid'] = 'ID of the user';
...
$string['taskbulkcheckcleanup'] = 'Booking: clean up the bulk send check';
$string['taskbulkcheckreminder'] = 'Booking: remind about parked rule mails';
...
$string['waitlistrecycling_help'] = 'A person who lets an offer expire is locked out of further offers for this booking option. This setting controls what happens once everyone still on the waiting list is locked out this way: "Stop" leaves them locked out permanently. "Go through again" resets those locks and offers seats to them again (in their original order), as soon as this is next checked by the waitlist heartbeat task. "Open up" leaves the freed seat open for direct booking by anyone (waiting-list or not) except those who actively declined their offer, until someone actually takes it - after which the waiting list resumes working normally for anyone joining afterwards. "Remove from waiting list when offer expires" does not wait for a full pass-through: as soon as a person\'s offer expires, they are removed from the waiting list (including an item already reserved in their shopping cart), without cancellation notifications. They can sign up again at any time and then join at the end of the waiting list. A person who actively declines an offer is always locked out permanently, regardless of this setting.';
$string['waitlistrecyclingend'] = 'Stop';
$string['waitlistrecyclingopen'] = 'Open up after full pass-through';
$string['waitlistrecyclingrecycle'] = 'Go through again';
$string['waitlistrecyclingremove'] = 'Remove from waiting list when offer expires';
