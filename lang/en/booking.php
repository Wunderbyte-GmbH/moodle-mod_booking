...
$string['slot_booking_duration'] = 'Duration';
...
$string['slot_calendar_month'] = 'Month';
...
$string['slot_calendar_price_legend'] = 'Price legend:';
$string['slot_calendar_select_slot'] = 'Select a slot to view booked students.';
$string['slot_calendar_selected_count'] = '{$a->selected}/{$a->max} selected';
...
$string['slot_calendar_week'] = 'Week';
$string['slot_calendar_week_of'] = 'Week of {$a}';
...
$string['taskremoveresponsesonunenrol'] = 'Booking: Remove booking answers after course unenrolment (adhoc task)';
...
$string['taskupdateteachercalendarentries'] = 'Booking: Update teacher calendar entries (adhoc task)';
