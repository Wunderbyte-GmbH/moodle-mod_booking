...
$string['enrollink:0'] = 'An error occured during the enrolment'; // MOD_BOOKING_AUTOENROL_STATUS_EXCEPTION.
$string['enrollink:1'] = 'You are already enrolled to this course and can access it'; // MOD_BOOKING_AUTOENROL_STATUS_ALREADY_ENROLLED.
$string['enrollink:2'] = 'Successfully enrolled'; // MOD_BOOKING_AUTOENROL_STATUS_SUCCESS.
$string['enrollink:3'] = 'Your enrolment link is invalid.'; // MOD_BOOKING_AUTOENROL_STATUS_INVALID_ENROLLINK.
$string['enrollink:4'] = 'There are no more places available in the bundle.'; // MOD_BOOKING_AUTOENROL_STATUS_NO_MORE_SEATS.
