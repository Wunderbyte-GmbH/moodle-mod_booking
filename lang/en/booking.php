...
$string['marmara:baseurl'] = 'Base URL';
$string['marmara:baseurl_desc'] = 'The base URL of the Marmara Respond API.';
$string['marmara:clientid'] = 'Client ID';
$string['marmara:clientid_desc'] = 'The ID of the client for Marmara Respond.';
$string['marmara:defaultsync'] = 'Sync Booking Options by Default';
$string['marmara:defaultsync_desc'] = 'If enabled, booking options will be synced by default.';
$string['marmara:importpersonadhoc'] = 'Booking: Sync person (adhoc task)';
$string['marmara:keyworddisplay'] = '(ID: {$a->id}) {$a->name}';
$string['marmara:keywordid'] = 'Keyword ID';
$string['marmara:keywordid_help'] = 'This value will be fetched automatically when you save the settings.';
$string['marmara:keywordidinfo'] = 'Save to get ID';
$string['marmara:keywordparentid'] = 'Keyword Parent ID';
$string['marmara:keywordparentid_desc'] = 'The ID of the parent keyword (Parent Criteria).';
$string['marmara:keywordparentname'] = 'Keyword Parent Name';
$string['marmara:keywordparentname_desc'] = 'The Name of the parent keyword (Parent Criteria).';
$string['marmara:marmaraenabled'] = 'Enable Marmara Respond';
$string['marmara:marmaraenabled_desc'] = 'If enabled, this plugin will sync with Marmara Respond.';
$string['marmara:marmarasettingsheading'] = 'Marmara Respond Settings';
$string['marmara:marmarasettingsheading_desc'] = 'Configure the connection to Marmara Respond below.';
$string['marmara:secret'] = 'Secret Token';
$string['marmara:secret_desc'] = 'The secret token used for authentication with Marmara Respond.';
$string['marmara:selectparentkeyword'] = 'Select parent Keyword';
$string['marmara:selectparentkeyword_help'] = 'Select a parent keyword from the list. This will be used to group or organize keywords in Marmara. If left empty, a default root keyword will be used.';
$string['marmara:sync'] = 'Sync';
