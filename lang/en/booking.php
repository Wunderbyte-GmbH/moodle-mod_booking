...
$string['ruletemplatebookingoptioncompletedbody'] = "<p>You have completed the following booking option:<br>{bookingdetails}<br>To the course: {courselink}<br>View all booking options: {bookinglink}</p>";
