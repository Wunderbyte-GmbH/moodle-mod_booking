...
$string['editoptionsreturnurl'] = 'Return page after editing without course login';
$string['editoptionsreturnurl_desc'] = 'Page (local url, e.g. /local/mypage/index.php) where teachers who are not enrolled in the course are taken after saving or cancelling the booking option form. Only used if "Course login required to edit booking options" is disabled. If empty, they return to their teacher page. Other users and users who are enrolled in the course are not affected.';
...
$string['mymanagedcourselist'] = 'Show the booking options I am teaching or responsible for.';
$string['name'] = 'Name';
