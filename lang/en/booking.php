...
$string['teacherpagevisibilitymode'] = 'Assigned teachers\' visibility of hidden options on teacher pages';
$string['teacherpagevisibilitymode:both'] = 'Assigned teachers may see fully invisible and direct-link-only options';
$string['teacherpagevisibilitymode:default'] = 'Default behaviour (hidden options remain hidden)';
$string['teacherpagevisibilitymode:directlinkonly'] = 'Assigned teachers may see direct-link-only options';
$string['teacherpagevisibilitymode:fullyinvisible'] = 'Assigned teachers may see fully invisible options';
$string['teacherpagevisibilitymode_desc'] = 'Controls which hidden booking options assigned teachers can see on their public teacher profile. Only options where the teacher is assigned will be shown. This setting does not affect users with the \'canseeinvisibleoptions\' capability, who can always see all hidden options';
