...
$string['caleventtype'] = 'Type of event';
$string['caleventtypeuser'] = 'User';
$string['caleventtypegroup'] = 'Group';
$string['caleventtypecourse'] = 'Course';
$string['caleventtypecoursecat'] = 'Category';
$string['caleventtypesite'] = 'Site';
