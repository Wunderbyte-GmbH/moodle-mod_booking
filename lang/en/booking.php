...
$string['agent_booking_verify_field_ticketdesign_failed'] = 'Field "ticketdesign" could not be confirmed after save. Requested "{$a->requested}", stored "{$a->actual}".';
...
$string['agent_ticket_feature_disabled'] = 'Entry tickets are not enabled on this site. An administrator has to switch on "Enable entry tickets" in the Booking site settings first.';
$string['agent_ticket_no_design'] = 'The ticket settings need a ticket design. Please provide ticketdesign with the name of the certificate template to use as the entry ticket.';
...
$string['booking:scanticket'] = 'Scan and verify entry tickets (check participants in)';
...
$string['booking:viewticketreport'] = 'View the entry-ticket overview (dashboard)';
...
$string['bookingticketcheckinstatus'] = 'Presence status set on check-in';
$string['bookingticketcheckinstatus_desc'] = 'The presence status a successful ticket scan sets for the participant. Keep this distinct from the status that issues completion certificates so a check-in never triggers a second certificate.';
$string['bookingticketcounterhint'] = 'The presence counter of the bookings tracker counts a different presence status than the one set on check-in. Dates checked in with the scanner will not be counted until "Presence status to count" and "Presence status set on check-in" match.';
$string['bookingticketcreatetemplate'] = 'Example ticket template';
$string['bookingticketcreatetemplate_desc'] = 'Create a ready-made ticket design in the certificate templates. You can then select it in a booking option, or duplicate it and adapt the layout to your needs.';
$string['bookingticketcreatetemplatebutton'] = 'Create example ticket template';
...
$string['bookingticketon'] = 'Enable entry tickets';
$string['bookingticketon_desc'] = 'When enabled, the "Ticketing" section becomes available in the booking option form. A ticket is created for every successful booking of an option that has a ticket design selected.';
$string['bookingticketserialscan'] = 'Serial scan mode';
$string['bookingticketserialscan_desc'] = 'Return to the camera automatically after each confirmed or rejected ticket so a queue can be scanned without further interaction. If disabled, the scanner stops after each ticket.';
...
$string['certificatebookingnotes'] = 'Notes on the booking';
...
$string['datasource:bookingmessages'] = 'Booking messages sent';
...
$string['editoptionsrequirecourselogin'] = 'Course login required to edit booking options';
$string['editoptionsrequirecourselogin_desc'] = 'If enabled (default), users must be enrolled in the course (or the course must allow guest access) to open the booking option form (editoptions.php). If disabled, a site login is enough; the capability checks of the form still apply, so only teachers of the booking option or users with the required capabilities can edit it.';
...
$string['entity:recipient'] = 'Recipient';
$string['entity:sender'] = 'Sender';
$string['entity:supervisor'] = 'Supervisor';
$string['entitybookinganswer'] = 'Booking answer';
$string['entitybookingmessage'] = 'Booking message';
...
$string['issupervisor'] = 'Is supervisor';
...
$string['messagetype:cancelledbyparticipant'] = 'Cancelled by participant';
$string['messagetype:cancelledbyteacherorsystem'] = 'Cancelled by teacher or system';
$string['messagetype:changenotification'] = 'Change notification';
$string['messagetype:completed'] = 'Booking option completed';
$string['messagetype:confirmation'] = 'Booking confirmation';
$string['messagetype:custommessage'] = 'Custom message (booking rule)';
$string['messagetype:pollurlparticipant'] = 'Poll URL for participants';
$string['messagetype:pollurlteacher'] = 'Poll URL for teachers';
$string['messagetype:reminderparticipant'] = 'Participant reminder';
$string['messagetype:reminderteacher'] = 'Teacher reminder';
$string['messagetype:reportreminder'] = 'Reminder sent from report';
$string['messagetype:sessionreminder'] = 'Session reminder';
$string['messagetype:statuschanged'] = 'Status change';
$string['messagetype:unknown'] = 'Unknown message type';
$string['messagetype:waitinglist'] = 'Waiting list confirmation';
...
$string['mytaughtcourselist'] = 'Show the booking options I am teaching.';
$string['mytickets'] = 'My tickets';
$string['myticketsnone'] = 'You do not have any tickets yet.';
$string['name'] = 'Name';
...
$string['noticketselected'] = 'No ticket design selected';
...
$string['previewlabel_ticketconfirmidentity'] = 'Require identity confirmation';
$string['previewlabel_ticketdesign'] = 'Ticket design';
$string['previewlabel_ticketextrainfo'] = 'Additional ticket information';
$string['previewlabel_ticketpersonalized'] = 'Personalised ticket';
...
$string['privacy:metadata:bookingtickets'] = 'Entry tickets issued for booking answers, including a data snapshot used to render the ticket PDF';
$string['privacy:metadata:bookingtickets:answerid'] = 'Id of the booking answer the ticket was created for';
$string['privacy:metadata:bookingtickets:code'] = 'Unique verification code of the ticket, encoded in its QR code';
$string['privacy:metadata:bookingtickets:json'] = 'Snapshot of the booking option and user data (e.g. the full name) at ticket creation, used to render the PDF';
$string['privacy:metadata:bookingtickets:optionid'] = 'Id of the booking option the ticket belongs to';
$string['privacy:metadata:bookingtickets:personalized'] = 'Whether the ticket is only valid for the registered holder';
$string['privacy:metadata:bookingtickets:status'] = 'Whether the ticket is valid or cancelled';
$string['privacy:metadata:bookingtickets:timecreated'] = 'Time the ticket was created';
$string['privacy:metadata:bookingtickets:timemodified'] = 'Time the ticket was last modified';
$string['privacy:metadata:bookingtickets:timerevoked'] = 'Time the ticket was cancelled';
$string['privacy:metadata:bookingtickets:userid'] = 'Id of the user holding the ticket';
...
$string['sendticket'] = 'Send ticket';
$string['sendticket_desc'] = 'Sends the entry ticket of the booking option to the selected users, with the ticket PDF attached.';
$string['session'] = 'Date';
...
$string['shortcode:userid'] = 'Shows the ID of the current user.';
...
$string['statuscheckedin'] = "Checked in";
...
$string['tasksendticketbyruleadhoc'] = 'Booking: Send ticket by rule (adhoc task)';
...
$string['ticket_help'] = 'The certificate template used as the layout of the entry ticket. Leave empty to create no tickets for this booking option.';
$string['ticketalreadypresent'] = 'Already checked in at {$a}';
$string['ticketbutton'] = 'Ticket';
$string['ticketbuttoncolumn'] = 'Ticket (download button)';
$string['ticketcode'] = 'Ticket code';
$string['ticketconfiguredviarule'] = 'Tickets are created automatically when someone books this option. To deliver them, create a booking rule that reacts on the event "Entry ticket created" and uses the action "Send ticket".';
$string['ticketconfirmentry'] = 'Confirm entry';
$string['ticketconfirmidentity'] = 'Require identity confirmation';
$string['ticketconfirmidentity_help'] = 'If enabled, the scanner shows the identity data of the holder (as configured in the site settings) even for tickets that are not personalised, and a check-in is only recorded after entry staff explicitly confirmed the person at the door. Use this for exams and other events where identity matters. If neither this nor "Personalised ticket" is ticked, a scan checks the participant in at once, without a confirmation by entry staff.';
$string['ticketconfirmidentitylabel'] = 'Always show identity data and require an explicit confirmation before checking in';
$string['ticketcreated'] = 'Entry ticket created';
$string['ticketcreateddesc'] = 'An entry ticket with id \'{$a->objectid}\' was created for the user with id \'{$a->relateduserid}\' for the booking option with id \'{$a->optionid}\'.';
$string['ticketdownload'] = 'Download ticket';
$string['ticketentryrejected'] = 'Entry rejected';
$string['ticketextrainfo'] = 'Additional ticket information';
$string['ticketextrainfo_help'] = 'Free text printed on the ticket, for example entry rules or directions. To make it visible, the ticket design has to contain a field element showing "Additional ticket information".';
$string['ticketfilenameprefix'] = 'ticket';
$string['ticketheader'] = 'Ticketing';
$string['ticketholder'] = 'Ticket holder';
$string['ticketidentityfullname'] = 'Full name';
$string['ticketidentitypicture'] = 'Profile picture';
$string['ticketissuedon'] = 'Issued on';
$string['ticketnofile'] = 'The ticket PDF has not been created yet.';
$string['ticketnotfound'] = 'No valid ticket';
$string['ticketpersonalized'] = 'Personalised ticket';
$string['ticketpersonalized_help'] = 'A personalised ticket is only valid for the person it was created for and may not be passed on or resold. This is stated on the public verification page so a potential buyer can see that an offered ticket cannot legally change hands.';
$string['ticketpersonalizedlabel'] = 'Only valid for the registered holder';
$string['ticketregenerate'] = 'Recreate ticket';
$string['ticketrejected'] = 'Entry ticket rejected';
$string['ticketrejectedinfo'] = 'The user with id \'{$a->scanner}\' rejected the entry ticket of {$a->relateduser} for booking option with id \'{$a->optionid}\' (date id \'{$a->optiondateid}\').';
$string['ticketrejectentry'] = 'Reject';
$string['ticketrevoked'] = 'This ticket was cancelled on {$a} and is no longer valid.';
$string['ticketscanafter'] = 'Scanner available after each date';
$string['ticketscanafter_help'] = 'How long after the end of each date of this option the ticket scanner stays available. 0 means unlimited. Options without dates are always available for scanning.';
$string['ticketscanbefore'] = 'Scanner available before each date';
$string['ticketscanbefore_help'] = 'How long before the start of each date of this option the ticket scanner opens. 0 means unlimited. Options without dates are always available for scanning.';
$string['ticketscanned'] = 'Entry ticket scanned';
$string['ticketscannedinfo'] = 'The user with id \'{$a->scanner}\' checked in {$a->relateduser} via an entry ticket for booking option with id \'{$a->optionid}\' (date id \'{$a->optiondateid}\').';
$string['ticketscanner'] = 'Ticket scanner';
$string['ticketscannercheckedin'] = 'Checked in';
$string['ticketscannerclose'] = 'Close';
$string['ticketscannerclosed'] = 'The ticket scanner is not available for this event at the moment.';
$string['ticketscannerclosednextopen'] = 'It opens on {$a}.';
$string['ticketscannerconfirmprompt'] = 'Confirm to check in for this date.';
$string['ticketscannercounter'] = 'Admitted: {$a->present} / {$a->booked}';
$string['ticketscannerdate'] = 'Date';
$string['ticketscannerdatepresent'] = '{$a} (checked in)';
$string['ticketscannerduplicate'] = 'Already scanned a moment ago.';
$string['ticketscannererror'] = 'Could not verify the ticket. Please try again.';
$string['ticketscannerforoption'] = 'Scanning tickets for: {$a}';
$string['ticketscannerhttpswarning'] = 'The camera is only available over a secure connection (HTTPS). Scanning will not work here.';
$string['ticketscannerinvalid'] = 'No valid ticket';
$string['ticketscannerlastscan'] = 'Last successful scan';
$string['ticketscannernext'] = 'Next';
$string['ticketscannernocamera'] = 'No camera available on this device.';
$string['ticketscannernodetector'] = 'This browser cannot scan QR codes. Use Chrome on Android, or open the ticket verification link directly.';
$string['ticketscannerpermissiondenied'] = 'Camera access was denied. Allow camera access to scan tickets.';
$string['ticketscanners'] = 'Additional entry staff';
$string['ticketscanners_help'] = 'Users who may scan the tickets of this booking option at the door without holding the capability "Scan entry tickets". You can only pick users whose profile you may view; users you cannot see stay in the list when you save. Entry staff must be enrolled in the course to open the scanner.';
$string['ticketscannerscanning'] = 'Point the camera at a ticket QR code…';
$string['ticketscannerstart'] = 'Start scanner';
$string['ticketscannerstartprompt'] = 'Press "Start scanner" and allow camera access.';
$string['ticketscannerstop'] = 'Stop scanner';
$string['ticketscannerstopped'] = 'Scanner stopped.';
$string['ticketscannerwrongoption'] = 'This ticket belongs to another event: {$a}';
$string['ticketstatuscancelled'] = 'Cancelled';
$string['ticketstatusvalid'] = 'Valid';
$string['tickettemplatecreated'] = 'The example ticket template "{$a}" was created.';
$string['tickettemplatemissing'] = 'The selected ticket design no longer exists. Please choose another one.';
$string['tickettemplatename'] = 'Booking ticket';
$string['tickettitle'] = 'TICKET';
$string['ticketurl'] = 'Ticket download URL';
$string['ticketvalid'] = 'Valid ticket';
$string['ticketverifycancelled'] = 'This ticket has been cancelled and is no longer valid.';
$string['ticketverifyheading'] = 'Check entry ticket';
$string['ticketverifyidentityprompt'] = 'Check that this is the person in front of you.';
$string['ticketverifynotfound'] = 'No valid ticket was found for this code.';
$string['ticketverifypersonalizedhint'] = 'This is a personalised ticket. It is only valid for the person it was created for and cannot be passed on or resold.';
$string['ticketverifystafflogin'] = 'Log in as entry staff to check this participant in.';
$string['ticketverifytransferablehint'] = 'This ticket is not bound to a specific person and may be passed on.';
$string['ticketverifyurl'] = 'Ticket verification URL';
$string['ticketverifyvalid'] = 'This ticket is valid.';
