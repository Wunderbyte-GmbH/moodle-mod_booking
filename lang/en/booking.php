...
$string['agent_booking_blocker_followup_bookingpolicy'] =
    'Please confirm how booking policy consent should be transmitted.';
$string['agent_booking_blocker_followup_customform'] =
    'Please provide the required custom form values that should be transmitted.';
...
$string['ai_trial_token_invalid_message'] = 'Your AI trial token is no longer valid. Please purchase or activate a subscription token to continue.';
