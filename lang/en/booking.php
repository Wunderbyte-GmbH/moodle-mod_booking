...
$string['maxoptionsfromcategory'] = 'Should it be possible to limit the number of bookings per category?';
...
$string['ruletemplatebookingoptioncompleted'] = "Template - Bookingoption completed";
$string['ruletemplatebookingoptioncompletedbody'] = "<p>You have completed the following booking option:<br>{bookingdetails}<br> Please participate in the Poll. Poll link: {pollurl} <br>To the course: {courselink}<br>View all booking options: {bookinglink}</p>";
...
$string['ruletemplateconfirmbookingbody'] = "<p>Dear {firstname} {lastname},<br>Thank you very much for your booking<br>{bookingdetails}<br>All the best!</p>";
$string['ruletemplateconfirmbookingsubject'] = "You have successfully booked";
$string['ruletemplateconfirmwaitinglist'] = "Template - Confirm Waitinglist";
$string['ruletemplateconfirmwaitinglistbody'] = "<p>Dear {firstname} {lastname},<br>You are on the waiting list<br>{bookingdetails}<br>All the best!</p>";
$string['ruletemplateconfirmwaitinglistsubject'] = "You are on the waiting list";
$string['ruletemplatecourseupdate'] = "Template - Update";
$string['ruletemplatecourseupdatebody'] = "<p>This is new: <br> {changes} <br> Click the following link to view the change(s) and an overview of all bookings: {bookinglink}</p>";
...
$string['ruletemplatedaysbeforebody'] = "<p>Your booking starts in a few days: {bookingdetails} <br> Name: {participant} <br> To get an overview of all bookings, click on the following link:{bookinglink}<br> Here is the link to the course: {courselink}</p>";
$string['ruletemplatedaysbeforesubject'] = "Your booking starts in a few days";
$string['ruletemplatetrainerpoll'] = "Template - Trainer Poll";
$string['ruletemplatetrainerpollbody'] = "<p>Please participate in the Poll. Poll link: {pollurlteachers}</p>";
$string['ruletemplatetrainerpollsubject'] = "Poll";
$string['ruletemplatetrainerreminder'] = "Template - Trainer Reminder";
$string['ruletemplatetrainerreminderbody'] = "<p>Your course starts in a few days:<br>{bookingdetails}<br>You have {numberparticipants} participants and {numberwaitinglist} people on the waiting list.<br>To get an overview of all bookings, click on the following link<br>{bookinglink}<br>Hier geht's zum Kurs: {courselink}</p>";
$string['ruletemplatetrainerremindersubject'] = "Your booking starts in a few days";
$string['ruletemplateuserpoll'] = "Template - User Poll";
...
$string['ruletemplateuserstorno'] = "Template - User Storno";
