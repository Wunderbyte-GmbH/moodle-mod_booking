...
$string['slot_calendar_teachers'] = 'Booked teachers';
...
$string['slot_error_teacher_required'] = 'Please select a teacher.';
...
$string['slot_report_teachers'] = 'Assigned teachers';
...
$string['slot_student_teacher_assignments'] = 'Student teacher assignments';
$string['slot_student_teacher_assignments_desc'] = 'Assign one or more teachers from this option\'s teacher pool to each enrolled student.';
$string['slot_student_teacher_assignments_no_students'] = 'No enrolled students found in this course.';
$string['slot_student_teacher_assignments_no_teachers'] = 'No teachers are configured in this option\'s slot teacher pool.';
$string['slot_student_teacher_assignments_saved'] = 'Student teacher assignments were saved.';
$string['slot_student_teacher_assignments_teachers'] = 'Assigned teachers';
$string['slot_teacher_pool'] = 'Teacher pool';
$string['slot_teacher_unavailability'] = 'Teacher unavailability';
$string['slot_teacher_unavailability_for'] = 'Unavailability for {$a}';
$string['slot_teachers_required'] = 'Teachers required per slot';
