...
$string['allteacherspagebookinginstances'] = 'On "All teachers" page, show only teachers who are teaching in one of these selected Booking instances (select nothing here, if you want to show ALL teachers)';
