...
$string['slot_bookings_display_mode_availableforuser'] = 'Show the number of still available slots';
...
$string['slot_cart_numslots'] = 'Number of slots: {$a}';
...
$string['slot_day_slotcount'] = '{$a} slots';
...
$string['slot_legend_available'] = 'Available';
...
$string['slot_max_slots_per_user_help'] = 'The maximum number of slots a user may book in a SINGLE booking. Once "Allow to book again" permits them to start a new booking, this allowance starts again from zero: the slots from the earlier booking stay booked and keep their time ranges reserved, but no longer count towards this limit. With "Allow to book again" disabled, no second booking is possible at all, so this is effectively the total number of slots a user can hold.';
...
$string['slot_overview_heading'] = 'Slot availability';
...
$string['slot_price_legend'] = 'Price legend';
$string['slot_price_legend_free'] = 'Free';
...
$string['slot_release_action'] = 'Cancel slot';
$string['slot_release_cart_refused'] = 'This booking cannot be cancelled: {$a}';
$string['slot_release_confirm_body'] = 'Do you really want to cancel the slot "{$a}"? This cannot be undone.';
$string['slot_release_confirm_title'] = 'Cancel slot';
$string['slot_release_error_title'] = 'Cancelling this slot is not possible';
$string['slot_release_policy_blocked'] = 'Cancelling slots is not possible for this booking option.';
...
$string['slot_selection_count'] = '{$a->count} of {$a->max} selected';
$string['slot_selection_gotoday'] = 'Show this day in the calendar';
$string['slot_selection_remove'] = 'Remove this slot from the selection';
$string['slot_selection_selectedday'] = 'Slots selected on this day';
$string['slot_selection_summary_heading'] = 'Selected slots';
$string['slot_selection_total'] = 'Total';
...
$string['slot_update_confirm_cancel_all'] = 'This booking will then be cancelled completely.';
...
$string['slot_update_success_cancelled'] = 'Your booking has been cancelled.';
$string['slot_update_success_moved'] = 'Your slot has been moved to {$a}.';
$string['slot_update_success_updated'] = 'Your booking has been updated.';
...
$string['slotsbooked'] = 'Booked slots from a slot-booked event, otherwise the booked slots of the booking (e.g. in the booking confirmation).';
