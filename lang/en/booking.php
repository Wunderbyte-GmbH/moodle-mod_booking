...
$string['waitinglistbookingwindowhours'] = 'Booking time slot per person';
$string['waitinglistbookingwindowhours_desc'] = 'Enter the duration in hours for which it is possible for a person on the waiting list to book a place. If this value is set to 24, for example, ONLY the first person on the waiting list can book during the first 24 hours after a place becomes available, and ONLY the second person on the waiting list can book during the following 24 hours. 0 means that only the first person on the waiting list can book.';
