...
$string['ticketconfirmidentity_help'] = 'If enabled, the scanner shows the identity data of the holder (as configured in the site settings) even for tickets that are not personalised, and a check-in is only recorded after entry staff explicitly confirmed the person at the door. Use this for exams and other events where identity matters.';
