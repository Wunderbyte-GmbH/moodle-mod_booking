...
$string['bookingticketduplicatewindow_desc'] = 'Scanning the same code again within this many seconds is shown as "already checked" instead of re-processing it.';
...
$string['bookingticketserialscan_desc'] = 'Keep the scanner running after each result so a queue can be scanned without interaction.';
...
$string['ticketconfirmidentity_help'] = 'If enabled, scanning a ticket first shows the holder\'s name and profile picture. Entry staff has to confirm that the person at the door is the ticket holder before the check-in is recorded. Use this for exams and other events where identity matters. If disabled, a scan checks the participant in immediately.';
$string['ticketconfirmidentitylabel'] = 'Show name and picture and wait for confirmation before checking in';
...
$string['ticketscannedinfo'] = 'The user with id \'{$a->scanner}\' checked in {$a->relateduser} via an entry ticket for booking option with id \'{$a->optionid}\'.';
...
$string['ticketvalid'] = 'Valid ticket — admitted';
