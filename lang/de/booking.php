...
$string['enrollink:0'] = 'Beim Einschreiben ist ein Fehler passiert'; // MOD_BOOKING_AUTOENROL_STATUS_EXCEPTION.
$string['enrollink:1'] = 'Sie sind bereits in diesen Kurs eingeschrieben und können darauf zugreifen'; // MOD_BOOKING_AUTOENROL_STATUS_ALREADY_ENROLLED.
$string['enrollink:2'] = 'Sie sind erfolgreich eingeschrieben'; // MOD_BOOKING_AUTOENROL_STATUS_SUCCESS.
$string['enrollink:3'] = 'Ihr Einschreibelink ist leider fehlerhaft'; // MOD_BOOKING_AUTOENROL_STATUS_INVALID_ENROLLINK.
$string['enrollink:4'] = 'Es sind keine freien Plätze mehr in Ihrem Kontingent verfügbar'; // MOD_BOOKING_AUTOENROL_STATUS_NO_MORE_SEATS.
