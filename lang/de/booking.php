...
$string['teacherpagevisibilitymode'] = 'Sichtbarkeit versteckter Optionen für zugewiesene Trainer:innen auf Trainerprofilen';
$string['teacherpagevisibilitymode:both'] = 'Zugewiesene Trainer:innen können vollständig unsichtbare und nur über direkten Link sichtbare Optionen sehen';
$string['teacherpagevisibilitymode:default'] = 'Standardverhalten (versteckte Optionen bleiben versteckt)';
$string['teacherpagevisibilitymode:directlinkonly'] = 'Zugewiesene Trainer:innen können nur über direkten Link sichtbare Optionen sehen';
$string['teacherpagevisibilitymode:fullyinvisible'] = 'Zugewiesene Trainer:innen können vollständig unsichtbare Optionen sehen';
$string['teacherpagevisibilitymode_desc'] = 'Bestimmt, welche versteckten Buchungsoptionen zugewiesene Trainer:innen in ihrem öffentlichen Trainerprofil sehen können. Es werden nur Optionen angezeigt, bei denen die Trainer:in zugewiesen ist. Diese Einstellung beeinflusst nicht Benutzer:innen mit der Berechtigung \'canseeinvisibleoptions\', die immer alle versteckten Optionen sehen können';
