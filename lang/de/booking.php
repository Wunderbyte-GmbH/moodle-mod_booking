...
$string['bookingticketduplicatewindow_desc'] = 'Wird derselbe Code innerhalb dieser Sekundenzahl erneut gescannt, wird „bereits geprüft“ angezeigt statt erneut zu verarbeiten.';
...
$string['bookingticketserialscan_desc'] = 'Den Scanner nach jedem Ergebnis weiterlaufen lassen, damit eine Warteschlange ohne Interaktion gescannt werden kann.';
...
$string['ticketconfirmidentity_help'] = 'Wenn aktiviert, zeigt der Scan zuerst Name und Profilbild der Person an. Das Einlasspersonal muss bestätigen, dass die Person an der Tür die Ticketinhaberin bzw. der Ticketinhaber ist, bevor der Einlass gespeichert wird. Sinnvoll für Prüfungen und andere Veranstaltungen mit Identitätspflicht. Ohne diese Option wird beim Scan sofort eingelassen.';
$string['ticketconfirmidentitylabel'] = 'Vor dem Einlass Name und Bild anzeigen und Bestätigung abwarten';
...
$string['ticketscannedinfo'] = 'Die Person mit ID \'{$a->scanner}\' hat {$a->relateduser} per Eintrittsticket für die Buchungsoption mit ID \'{$a->optionid}\' eingelassen.';
...
$string['ticketvalid'] = 'Gültiges Ticket – eingelassen';
