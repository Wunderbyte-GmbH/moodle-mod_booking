...
$string['nooverlapblocking'] = 'Diese Option kann nicht gebucht werden, sie überlappt der von Ihnen gebuchten Option(en): {$a}';
$string['nooverlapwarning'] = 'Achtung, diese Option überlappt mit der von Ihnen gebuchten Option(en): {$a}';
