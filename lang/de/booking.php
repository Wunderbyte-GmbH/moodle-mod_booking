...
$string['slot_calendar_teachers'] = 'Gebuchte Lehrpersonen';
...
$string['slot_error_teacher_required'] = 'Bitte wählen Sie eine Lehrperson aus.';
...
$string['slot_report_teachers'] = 'Zugewiesene Trainer:innen';
...
$string['slot_student_teacher_assignments_no_teachers'] = 'In dieser Option sind keine Lehrpersonen im Trainer:innen-Pool konfiguriert.';
$string['slot_student_teacher_assignments_saved'] = 'Trainer:innen-Zuweisungen wurden gespeichert.';
$string['slot_student_teacher_assignments_teachers'] = 'Zugewiesene Lehrpersonen';
$string['slot_teacher_pool'] = 'Trainer:innen-Pool';
$string['slot_teacher_unavailability'] = 'Trainer:innen-Abwesenheit';
$string['slot_teacher_unavailability_for'] = 'Abwesenheiten für {$a}';
$string['slot_teachers_required'] = 'Benötigte Trainer:innen pro Slot';
