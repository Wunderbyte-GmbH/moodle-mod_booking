...
$string['addcertificatecondition'] = 'Zertifikatsbedingung hinzufügen';
...
$string['addoption'] = 'Option hinzufügen';
...
$string['agent_booking_configure_use_list_instance_settings'] = 'Dieser Skill aktualisiert ausschließlich die Einstellungen der Buchungsinstanz. Um die konfigurierbaren Felder und ihre aktuellen Werte aufzulisten, verwenden Sie den schreibgeschützten Skill mod_booking.list_instance_settings.';
...
$string['banusernameswarning'] = 'Ihr Benutzername ist gesperrt, daher können Sie nicht buchen.';
$string['before'] = 'Vor';
$string['beforebookedtext'] = 'Vor der Buchung';
$string['beforebookedtext_help'] = 'Nachricht, die vor der Buchung der Option angezeigt wird';
...
$string['bocondisloggedinavailable'] = 'Jetzt buchen';
$string['bocondisloggedinfullavailable'] = 'Buchung ist möglich';
...
$string['booking:bookmyteam'] = 'Mein Team buchen';
...
$string['booking:comment'] = 'Kommentare hinzufügen';
...
$string['booking:editcertificateconditions'] = 'Zertifikatsbedingungen bearbeiten';
...
$string['booking:managecomments'] = 'Kommentare verwalten';
...
$string['booking:skill_mod_booking_list_instance_settings'] = 'KI-Skill: Einstellungen der Buchungsinstanz auflisten';
...
$string['bookingactionsheader'] = 'Aktionen nach der Buchung [EXPERIMENTELL]';
...
$string['cachedef_sqlfilterrelevance'] = 'Referenzierte Werte der SQL-Verfügbarkeitsfilter-Bedingungen (Cache)';
...
$string['cachereportactioncheckcron'] = 'Prüfen Sie, ob Cron und Adhoc-Tasks auf dieser Website ausgeführt werden.';
$string['cachereportactioncontactwb'] = 'Bitte kontaktieren Sie Wunderbyte zur Analyse.';
$string['cachereportactionredis'] = 'Erwägen Sie, die betroffenen Cache-Definitionen einem Redis-Store mit maxmemory und einer allkeys-lru-Eviction-Policy zuzuordnen, und kontaktieren Sie Wunderbyte.';
$string['cachereportdaybucket'] = 'Erfasster Tages-Bucket des Buchungszeit-Filters';
$string['cachereportdistinctstems'] = 'Unterschiedliche Cache-Key-Stämme in der Stichprobe';
$string['cachereportfilteractive'] = 'SQL-Verfügbarkeitsfilter aktiv';
$string['cachereportfindingentrysizecritical'] = 'Es werden sehr große Cache-Objekte gespeichert (durchschnittliche Eintragsgröße {$a}).';
$string['cachereportfindingentrysizeok'] = 'Die Größen der Cache-Einträge sind unauffällig (größte durchschnittliche Eintragsgröße {$a}).';
$string['cachereportfindingentrysizewarning'] = 'Es werden große Cache-Objekte gespeichert (durchschnittliche Eintragsgröße {$a}).';
...
$string['cachereportfindingquerytimecritical'] = 'Die gefilterte Options-Abfrage ist sehr langsam ({$a} ms).';
$string['cachereportfindingquerytimeok'] = 'Die gefilterte Options-Abfrage ist schnell ({$a} ms).';
$string['cachereportfindingquerytimewarning'] = 'Die gefilterte Options-Abfrage wird langsam ({$a} ms).';
$string['cachereportfindingrolloverok'] = 'Die tägliche Bereinigung der datierten Tabellen-Caches ist auf aktuellem Stand.';
$string['cachereportfindingrolloverwarning'] = 'Die tägliche Bereinigung der datierten Tabellen-Caches scheint hinterherzuhinken (erfasster Tages-Bucket {$a->bucket}, ausstehende Purge-Tasks {$a->tasks}).';
$string['cachereportfindingtotalsizecritical'] = 'Die betroffenen Cache-Definitionen sind insgesamt sehr groß ({$a}).';
$string['cachereportfindingtotalsizeok'] = 'Die Gesamtgröße der betroffenen Cache-Definitionen ist unauffällig ({$a}).';
$string['cachereportfindingtotalsizewarning'] = 'Die betroffenen Cache-Definitionen werden insgesamt groß ({$a}).';
$string['cachereporthits'] = 'Cache-Treffer';
$string['cachereportinactive'] = 'Der SQL-Verfügbarkeitsfilter ist nicht aktiv, es gibt nichts zu erfassen.';
...
$string['cachereportitems'] = 'Einträge';
$string['cachereportlargestinstance'] = 'Größte Buchungsinstanz (Optionen)';
$string['cachereportlogfilter'] = 'Filter-Cache-Log der Wunderbyte-Tabelle';
$string['cachereportlogfilterdisabled'] = 'Das Filter-Cache-Log von local_wunderbyte_table ist deaktiviert; aktivieren Sie es vorübergehend, um Trefferzahlen zu erfassen.';
$string['cachereportlogfiltersettinglink'] = 'Einstellungen der Wunderbyte-Tabelle öffnen (logfiltercaches)';
$string['cachereportmarkervalue'] = 'Markierungswert des SQL-Filters';
$string['cachereportmeansize'] = 'Durchschnittliche Eintragsgröße';
$string['cachereportnotsupported'] = 'Von diesem Store nicht unterstützt';
$string['cachereportoptioncount'] = 'Optionen';
$string['cachereportpendingpurgetasks'] = 'Ausstehende Purge-Tasks für datierte Caches';
$string['cachereportquerytimefiltered'] = 'Options-Zählabfrage MIT Filter (ms)';
$string['cachereportquerytimeplain'] = 'Options-Zählabfrage ohne Filter (ms)';
$string['cachereportreferencedvalues'] = 'Referenzierte Werte';
...
$string['cachereportsectionconfig'] = 'Konfiguration';
$string['cachereportsectionfindings'] = 'Status und Empfehlungen';
$string['cachereportsectionsample'] = 'Gemeinsame Nutzung der Cache-Keys';
$string['cachereportsectionsnapshots'] = 'Verlauf (tägliche Snapshots)';
$string['cachereportsectionstores'] = 'Nutzung der Cache-Stores';
$string['cachereportsectiontiming'] = 'Abfragezeiten';
$string['cachereportsnapshotsempty'] = 'Noch keine Snapshots erfasst. Der tägliche geplante Task sammelt sie automatisch.';
$string['cachereportstatuscritical'] = 'Kritisch';
$string['cachereportstatusok'] = 'OK';
$string['cachereportstatuswarning'] = 'Warnung';
$string['cachereporttopclasses'] = 'Größte Key-Klassen (Benutzer:innen pro Key)';
$string['cachereporttotalsize'] = 'Gesamtgröße';
$string['cachereportusedconditions'] = 'Verwendete Bedingungen mit SQL-Filter';
...
$string['changesinexpirydateabsolute'] = 'Zertifikat: ein absoluter Wert des Ablaufdatums';
$string['changesinexpirydaterelative'] = 'Zertifikat: ein relativer Wert des Ablaufdatums';
$string['changesinexpirydatetype'] = 'Zertifikat: die Art des Ablaufdatums';
...
$string['condition:cohort'] = 'Globale Gruppe';
...
$string['confirmoptioncompletionbody'] = 'Der Abschlussstatus der ausgewählten Buchungen wird umgeschaltet:
 Buchungen, die noch nicht abgeschlossen sind, werden als abgeschlossen markiert und umgekehrt.';
...
$string['confirmpresence'] = 'Anwesenheit bestätigen';
...
$string['copyonlythisbookingurl'] = 'Diese Buchungs-URL kopieren';
$string['copypollurl'] = 'Umfrage-URL kopieren';
...
$string['createfield'] = 'Neues dynamisches Dropdown-Feld erstellen';
...
$string['customfieldoptions'] = 'Liste der möglichen Werte';
...
$string['enrolledinoptions'] = 'bereits in Buchungsoptionen gebucht: ';
...
$string['error_duplicatekey'] = 'Dieser gespeicherte Wert wird mehr als einmal verwendet. Jede Option benötigt einen eindeutigen Wert.';
$string['error_invalidshortname'] = 'Der Kurzname darf nur Kleinbuchstaben, Ziffern und Unterstriche enthalten.';
$string['error_nestedparent'] = 'Es ist nur eine Hierarchieebene erlaubt. Das ausgewählte übergeordnete Element ist bereits ein untergeordnetes Element und kann daher keine eigenen Unterelemente haben.';
$string['error_nofieldselected'] = 'Bitte wählen Sie ein benutzerdefiniertes Feld zur Verwaltung aus.';
$string['error_nomanageablefields'] = 'Es wurden noch keine benutzerdefinierten Buchungsfelder vom Typ dynamisches Dropdown (dynamicformat) gefunden. Erstellen Sie unten eines.';
$string['error_notbookingfield'] = 'Das ausgewählte Feld ist kein benutzerdefiniertes Feld einer mod_booking-Option.';
$string['error_notdynamicfield'] = 'Das ausgewählte Feld ist kein dynamisches Dropdown-Feld (dynamicformat).';
$string['error_shortnameexists'] = 'Ein benutzerdefiniertes Buchungsfeld mit diesem Kurznamen existiert bereits.';
$string['error_unknownparent'] = 'Das ausgewählte übergeordnete Element existiert nicht.';
$string['errorcreationofoptionwentwrong'] = 'Fehler beim Erstellen der Option.';
...
$string['errorloadingtemplate'] = 'Fehler beim Laden der Vorlage.';
$string['errorloadinguserdata'] = 'Fehler beim Laden der Benutzerdaten.';
...
$string['erroronsetdata'] = 'Fehler bei set_data.';
...
$string['errorupdateofoptionwentwrong'] = 'Fehler beim Aktualisieren der Option.';
...
$string['fieldcreated'] = 'Dynamisches Dropdown-Feld erstellt.';
...
$string['mybookingsbooking'] = 'Buchung (Kurs)';
...
$string['name'] = 'Name';
$string['newcategory'] = 'Neue Kategorie erstellen';
...
$string['newfieldcategory'] = 'Kategorie';
$string['newfieldname'] = 'Feldname';
$string['newfieldshortname'] = 'Kurzname des Feldes';
$string['newfieldshortname_help'] = 'Nur Kleinbuchstaben, Ziffern und Unterstriche. Muss unter den benutzerdefinierten Buchungsfeldern eindeutig sein.';
...
$string['notallowedtobookforothers'] = 'Buchen für andere nicht erlaubt';
...
$string['previewcfg_allowupdate'] = 'Buchungsänderungen erlauben';
$string['previewcfg_bookingpolicy'] = 'Buchungsbedingungen';
$string['previewcfg_cancancelbook'] = 'Stornierung erlauben';
$string['previewcfg_daystonotify'] = 'Tage vor dem Termin für die Benachrichtigung der Teilnehmenden';
$string['previewcfg_daystonotifyteachers'] = 'Tage vor dem Termin für die Benachrichtigung der Trainer:innen';
$string['previewcfg_duration'] = 'Standarddauer';
$string['previewcfg_eventtype'] = 'Terminart';
$string['previewcfg_intro'] = 'Beschreibung / Einleitung';
$string['previewcfg_maxperuser'] = 'Max. Buchungen pro Person';
$string['previewcfg_name'] = 'Name';
$string['previewcfg_notifyemail'] = 'E-Mail-Adresse für Benachrichtigungen (Teilnehmende)';
$string['previewcfg_notifyemailteachers'] = 'E-Mail-Adresse für Benachrichtigungen (Trainer:innen)';
$string['previewcfg_organizatorname'] = 'Name der Veranstalterin bzw. des Veranstalters';
$string['previewcfg_paginationnum'] = 'Optionen pro Seite';
$string['previewcfg_points'] = 'Punkte';
$string['previewcfg_pollurl'] = 'Umfrage-URL (Teilnehmende)';
...
$string['previewcfg_pollurltext'] = 'Linktext der Umfrage-URL (Teilnehmende)';
$string['previewcfg_sendmail'] = 'Bestätigungs-E-Mail senden';
$string['previewcfg_sendmailtobooker'] = 'E-Mail an die buchende Person senden';
$string['previewcfg_showinapi'] = 'In API anzeigen';
$string['previewlabel_active'] = 'Aktiv';
$string['previewlabel_address'] = 'Adresse';
$string['previewlabel_appliesto'] = 'Gilt für';
$string['previewlabel_availabilitywindow'] = 'Verfügbarkeitszeitraum';
$string['previewlabel_bookingcloses'] = 'Buchung endet';
$string['previewlabel_bookingopens'] = 'Buchung beginnt';
$string['previewlabel_defaultprice'] = 'Standardpreis';
$string['previewlabel_end'] = 'Ende';
$string['previewlabel_identifier'] = 'Bezeichner';
$string['previewlabel_location'] = 'Ort';
$string['previewlabel_markcompleted'] = 'Als abgeschlossen markieren';
$string['previewlabel_name'] = 'Name';
$string['previewlabel_options'] = 'Optionen';
$string['previewlabel_participants'] = 'Teilnehmende';
$string['previewlabel_prices'] = 'Preise';
$string['previewlabel_question'] = 'Frage';
$string['previewlabel_requestedtarget'] = 'Angefordertes Ziel';
$string['previewlabel_rulename'] = 'Regelname';
$string['previewlabel_seats'] = 'Plätze';
$string['previewlabel_seatsperslot'] = 'Plätze pro Slot';
$string['previewlabel_sessions'] = 'Termine';
$string['previewlabel_slotlength'] = 'Slot-Länge';
$string['previewlabel_sortorder'] = 'Sortierreihenfolge';
$string['previewlabel_start'] = 'Start';
$string['previewlabel_targetactivity'] = 'Buchungsaktivität';
$string['previewlabel_teacher'] = 'Trainer:in';
$string['previewlabel_template'] = 'Vorlage';
$string['previewlabel_updateexisting'] = 'Bestehende Buchungen aktualisieren';
$string['previewlabel_valid'] = 'Gültig';
$string['previewlabel_visibility'] = 'Sichtbarkeit';
$string['previewlabel_waitinglist'] = 'Warteliste';
$string['previewlabel_weekdays'] = 'Wochentage';
$string['previewsummary_slotbooking'] = 'Buchbar {$a->window} an {$a->weekdays}, Slots zu {$a->duration} Minuten, Kapazität {$a->seats}, {$a->validity}.';
$string['previewtitle_addpricecategory'] = 'Preiskategorie hinzufügen';
$string['previewtitle_bookusers'] = 'Benutzer:innen buchen';
$string['previewtitle_bulkupdate'] = 'Mehrere Buchungsoptionen aktualisieren';
$string['previewtitle_configureinstance'] = 'Einstellungen der Buchungsinstanz aktualisieren';
$string['previewtitle_createoption'] = 'Buchungsoption erstellen';
$string['previewtitle_createrule'] = 'Regel aus Vorlage erstellen';
$string['previewtitle_createslotbooking'] = 'Slot-Buchungsoption erstellen';
$string['previewtitle_updateoption'] = 'Buchungsoption aktualisieren';
$string['previewtitle_updaterule'] = 'Regel aktualisieren';
$string['previewtitle_updatetrainer'] = 'Trainer:innen aktualisieren';
$string['previewvalue_active'] = 'Aktiv';
$string['previewvalue_alloptions'] = 'Alle Optionen';
$string['previewvalue_andnmore'] = '+{$a} weitere';
$string['previewvalue_hidden'] = 'Verborgen';
$string['previewvalue_inactive'] = 'Inaktiv';
$string['previewvalue_minutes'] = '{$a} Minuten';
...
$string['privacy:metadata:bookinganswers'] = 'Stellt die Buchung eines Termins dar';
$string['privacy:metadata:bookinganswers:bookingid'] = 'ID der Buchungsinstanz';
$string['privacy:metadata:bookinganswers:completed'] = 'Die buchende Person hat die Aufgabe abgeschlossen';
$string['privacy:metadata:bookinganswers:frombookingid'] = 'ID der verbundenen Buchung';
$string['privacy:metadata:bookinganswers:notes'] = 'Zusätzliche Notizen';
$string['privacy:metadata:bookinganswers:numrec'] = 'Datensatznummer';
$string['privacy:metadata:bookinganswers:optionid'] = 'ID der Buchungsoption';
$string['privacy:metadata:bookinganswers:status'] = 'Statusinformation zu dieser Buchung';
$string['privacy:metadata:bookinganswers:timecreated'] = 'Zeitstempel der Erstellung der Buchung';
$string['privacy:metadata:bookinganswers:timemodified'] = 'Zeitstempel der letzten Änderung der Buchung';
$string['privacy:metadata:bookinganswers:userid'] = 'Person, die für diesen Termin gebucht ist';
$string['privacy:metadata:bookinganswers:waitinglist'] = 'Wahr, wenn die Person auf der Warteliste steht';
$string['privacy:metadata:bookingenrollinkbundles'] = 'Kontingent an Plätzen';
$string['privacy:metadata:bookingenrollinkbundles:baid'] = 'ID der Buchungsantwort';
$string['privacy:metadata:bookingenrollinkbundles:courseid'] = 'ID des Kurses';
$string['privacy:metadata:bookingenrollinkbundles:erlid'] = 'Hashwert zur Gegenprüfung';
$string['privacy:metadata:bookingenrollinkbundles:optionid'] = 'ID der Buchungsoption';
$string['privacy:metadata:bookingenrollinkbundles:places'] = 'Gesamtanzahl der Plätze';
$string['privacy:metadata:bookingenrollinkbundles:timecreated'] = 'Zeitstempel der Erstellung des Datensatzes';
$string['privacy:metadata:bookingenrollinkbundles:timemodified'] = 'Zeitstempel der letzten Änderung des Datensatzes';
$string['privacy:metadata:bookingenrollinkbundles:userid'] = 'Benutzer-ID für den Datensatz';
$string['privacy:metadata:bookingenrollinkbundles:usermodified'] = 'Die Person, die die Änderung vorgenommen hat';
$string['privacy:metadata:bookingenrollinkitems'] = 'Die Elemente, die in einem Kontingent erworben werden können';
$string['privacy:metadata:bookingenrollinkitems:consumed'] = 'Kennzeichen für offen oder verbraucht';
$string['privacy:metadata:bookingenrollinkitems:erlid'] = 'Hash des Kontingents';
$string['privacy:metadata:bookingenrollinkitems:timecreated'] = 'Zeitstempel der Erstellung des Datensatzes';
$string['privacy:metadata:bookingenrollinkitems:timemodified'] = 'Zeitstempel der letzten Änderung des Datensatzes';
$string['privacy:metadata:bookingenrollinkitems:userid'] = 'Benutzer-ID für den Datensatz';
$string['privacy:metadata:bookinghistory'] = 'Protokolliert den Verlauf der Benutzerinteraktionen';
$string['privacy:metadata:bookinghistory:json'] = 'Zusätzliche Daten zum Buchungsverlauf';
$string['privacy:metadata:bookinghistory:status'] = 'Statusnummer der Buchung';
$string['privacy:metadata:bookinghistory:userid'] = 'Die ID der Person, die die Buchung erstellt hat';
$string['privacy:metadata:bookingicalsequence'] = 'iCal-Sequenz';
$string['privacy:metadata:bookingicalsequence:optionid'] = 'ID der Buchungsoption für iCal';
$string['privacy:metadata:bookingicalsequence:sequencevalue'] = 'Wert der iCal-Sequenz';
$string['privacy:metadata:bookingicalsequence:userid'] = 'Benutzer-ID für iCal';
$string['privacy:metadata:bookingodtdeductions'] = 'Diese Tabelle protokolliert, ob ein Teil des Honorars einer Trainerin bzw. eines Trainers bei fehlenden Stunden abgezogen werden soll.';
$string['privacy:metadata:bookingodtdeductions:optiondateid'] = 'Die ID des Optionstermins';
$string['privacy:metadata:bookingodtdeductions:reason'] = 'Grund für den Abzug.';
$string['privacy:metadata:bookingodtdeductions:timecreated'] = 'Zeitpunkt der Erstellung';
$string['privacy:metadata:bookingodtdeductions:timemodified'] = 'Zeitpunkt der letzten Änderung';
$string['privacy:metadata:bookingodtdeductions:userid'] = 'Benutzer-ID der Trainerin bzw. des Trainers, die bzw. der für diesen Optionstermin einen Abzug erhält.';
$string['privacy:metadata:bookingodtdeductions:usermodified'] = 'Die Person, die die Änderung vorgenommen hat';
$string['privacy:metadata:bookingoptiondatesanswers'] = 'Status der Optionstermine für die Person';
$string['privacy:metadata:bookingoptiondatesanswers:json'] = 'Zusatzdaten';
$string['privacy:metadata:bookingoptiondatesanswers:notes'] = 'Notizen';
$string['privacy:metadata:bookingoptiondatesanswers:optiondateid'] = 'ID des Optionstermins';
$string['privacy:metadata:bookingoptiondatesanswers:optionid'] = 'ID der Option';
$string['privacy:metadata:bookingoptiondatesanswers:status'] = 'Statusnummer';
$string['privacy:metadata:bookingoptiondatesanswers:timecreated'] = 'Zeitpunkt der Erstellung';
$string['privacy:metadata:bookingoptiondatesanswers:timemodified'] = 'Zeitpunkt der letzten Änderung';
$string['privacy:metadata:bookingoptiondatesanswers:userid'] = 'Benutzer-ID für den Datensatz';
$string['privacy:metadata:bookingoptiondatesanswers:usermodified'] = 'Die Person, die die Änderung vorgenommen hat';
$string['privacy:metadata:bookingoptiondatesteachers'] = 'Erfasst die Trainer:innen für jeden Termin.';
$string['privacy:metadata:bookingoptiondatesteachers:optiondateid'] = 'ID des Optionstermins';
$string['privacy:metadata:bookingoptiondatesteachers:userid'] = 'Die Benutzer-ID der Trainerin bzw. des Trainers.';
$string['privacy:metadata:bookingratings'] = 'Ihre Bewertung eines Termins';
$string['privacy:metadata:bookingratings:optionid'] = 'ID der bewerteten Buchungsoption';
$string['privacy:metadata:bookingratings:rate'] = 'Vergebene Bewertung';
$string['privacy:metadata:bookingratings:userid'] = 'Person, die diesen Termin bewertet hat';
...
$string['privacy:metadata:bookingsubbookinganswers'] = 'Speichert die Antworten (die Buchungen) einer Person für eine bestimmte Zusatzbuchung.';
$string['privacy:metadata:bookingsubbookinganswers:itemid'] = 'Die itemid kann mit der sboptionid übereinstimmen, es gibt jedoch Typen (z. B. Zeitslots, die Slots bereitstellen), bei denen eine sboptionid viele itemids bereitstellt.';
$string['privacy:metadata:bookingsubbookinganswers:json'] = 'Ergänzende Daten, falls erforderlich';
$string['privacy:metadata:bookingsubbookinganswers:optionid'] = 'Die Options-ID';
$string['privacy:metadata:bookingsubbookinganswers:sboptionid'] = 'ID der gebuchten Zusatzbuchung';
$string['privacy:metadata:bookingsubbookinganswers:status'] = 'Der Status der Buchung, also gebucht, Warteliste, im Warenkorb, auf einer Benachrichtigungsliste oder gelöscht';
$string['privacy:metadata:bookingsubbookinganswers:timecreated'] = 'Zeitpunkt der Erstellung';
$string['privacy:metadata:bookingsubbookinganswers:timeend'] = 'Zeitstempel für das Ende dieser Buchung';
$string['privacy:metadata:bookingsubbookinganswers:timemodified'] = 'Zeitpunkt der letzten Änderung';
$string['privacy:metadata:bookingsubbookinganswers:timestart'] = 'Zeitstempel für den Beginn dieser Buchung';
$string['privacy:metadata:bookingsubbookinganswers:userid'] = 'Benutzer-ID der gebuchten Person.';
$string['privacy:metadata:bookingsubbookinganswers:usermodified'] = 'Die Person, die die Änderung vorgenommen hat';
...
$string['privacy:metadata:bookingteachers:bookingid'] = 'ID der Buchungsinstanz für die Trainerin bzw. den Trainer';
$string['privacy:metadata:bookingteachers:calendarid'] = 'ID des Kalendereintrags für die Trainerin bzw. den Trainer';
$string['privacy:metadata:bookingteachers:completed'] = 'Ob die Aufgabe für die Trainerin bzw. den Trainer abgeschlossen ist';
$string['privacy:metadata:bookingteachers:optionid'] = 'ID der Buchungsoption, die unterrichtet wird';
$string['privacy:metadata:bookingteachers:userid'] = 'Person, die diesen Termin unterrichtet';
...
$string['privacy:metadata:bookinguserevents'] = 'Benutzerereignisse im Kalender';
$string['privacy:metadata:bookinguserevents:eventid'] = 'ID des Ereignisses in der Ereignistabelle';
$string['privacy:metadata:bookinguserevents:optiondateid'] = 'ID des Optionstermins (Session) für das Benutzerereignis';
$string['privacy:metadata:bookinguserevents:optionid'] = 'ID der Buchungsoption für das Benutzerereignis';
$string['privacy:metadata:bookinguserevents:userid'] = 'Benutzer-ID für das Benutzerereignis';
...
$string['privacy:metadata:bookingwaitlistdeclines:optionid'] = 'ID der Buchungsoption';
$string['privacy:metadata:bookingwaitlistdeclines:reason'] = 'Grund der Sperre (abgelehnt oder abgelaufen)';
$string['privacy:metadata:bookingwaitlistdeclines:timecreated'] = 'Zeitpunkt der Sperre';
$string['privacy:metadata:bookingwaitlistdeclines:userid'] = 'ID der Nutzerin/des Nutzers';
$string['privacy:metadata:bookingwaitlistoffers'] = 'Wartelisten-Angebote und -Entscheidungen pro Nutzer:in';
$string['privacy:metadata:bookingwaitlistoffers:expiresat'] = 'Ablaufzeitpunkt des Angebots';
$string['privacy:metadata:bookingwaitlistoffers:offeredat'] = 'Zeitpunkt des Angebots';
$string['privacy:metadata:bookingwaitlistoffers:optionid'] = 'ID der Buchungsoption';
$string['privacy:metadata:bookingwaitlistoffers:status'] = 'Status des Angebots';
$string['privacy:metadata:bookingwaitlistoffers:timecreated'] = 'Erstellungszeitpunkt des Angebots-Datensatzes';
$string['privacy:metadata:bookingwaitlistoffers:userid'] = 'ID der Nutzerin/des Nutzers';
...
$string['searchwaitinglist'] = 'Auf Warteliste';
...
$string['selectcustomfield'] = 'Benutzerdefiniertes Feld';
...
$string['selectfield'] = 'Auswahlliste';
...
$string['selectpresencestatus'] = 'Anwesenheitsstatus wählen';
...
$string['sendpollurltoteachers'] = 'Umfrage-URL senden';
$string['sendreminderemail'] = 'Erinnerungs-E-Mail senden';
...
$string['slot_booking_duration'] = 'Dauer';
$string['slot_booking_start'] = 'Start';
...
$string['slot_calendar_month'] = 'Monat';
...
$string['slot_calendar_price_legend'] = 'Preis-Legende:';
$string['slot_calendar_select_slot'] = 'Wählen Sie einen Slot aus, um die gebuchten Teilnehmenden zu sehen.';
$string['slot_calendar_selected_count'] = '{$a->selected}/{$a->max} ausgewählt';
$string['slot_calendar_slot_count'] = '{$a} Slots';
...
$string['slot_calendar_week'] = 'Woche';
$string['slot_calendar_week_of'] = 'Woche vom {$a}';
...
$string['tagdeleted'] = 'Die Tag-Vorlage wurde gelöscht!';
...
$string['taskcreatecachereportsnapshot'] = 'Booking: Snapshot für den Cache-Bericht erstellen';
...
$string['taskremoveresponsesonunenrol'] = 'Booking: Buchungsantworten nach Kurs-Abmeldung entfernen (Adhoc-Task)';
...
$string['taskwaitlistheartbeat'] = 'Booking: Wartelisten-Heartbeat (Selbstheilung)';
...
$string['waitlistheartbeatheading_desc'] = 'Prüft Wartelisten regelmäßig auf einen verlorenen Auslöser (z. B. einen abgestürzten Cron-Lauf) und repariert sie selbsttätig.';
$string['waitlistheartbeatinterval'] = 'Intervall des Wartelisten-Heartbeats';
$string['waitlistheartbeatinterval_desc'] = 'Wie oft blockierte Wartelisten erneut geprüft und selbsttätig repariert werden. Läuft unabhängig von dieser Einstellung nie häufiger als alle 5 Minuten.';
$string['waitlistrecycling'] = 'Warteliste nach vollständigem Durchlauf';
$string['waitlistrecycling_help'] = 'Wer ein Angebot verfallen lässt, wird für weitere Angebote zu dieser Buchungsoption gesperrt. Diese Einstellung legt fest, was geschieht, sobald alle noch auf der Warteliste verbliebenen Personen auf diese Weise gesperrt sind: "Stopp" belässt sie dauerhaft gesperrt. "Erneut durchlaufen" setzt diese Sperren zurück und bietet ihnen die Plätze erneut an (in ihrer ursprünglichen Reihenfolge), sobald dies das nächste Mal vom Wartelisten-Heartbeat-Task geprüft wird. "Nach vollständigem Durchlauf öffnen" lässt den frei gewordenen Platz für die direkte Buchung durch alle offen (mit oder ohne Warteliste), ausgenommen jene, die ihr Angebot aktiv abgelehnt haben, bis ihn tatsächlich jemand annimmt - danach arbeitet die Warteliste für alle, die danach beitreten, wieder normal. Wer ein Angebot aktiv ablehnt, wird unabhängig von dieser Einstellung dauerhaft gesperrt.';
$string['waitlistrecyclingend'] = 'Stopp';
$string['waitlistrecyclingopen'] = 'Nach vollständigem Durchlauf öffnen';
$string['waitlistrecyclingrecycle'] = 'Erneut durchlaufen';
