...
die man entweder selbst angelegt hat oder bei denen man als Trainer:in zugewiesen ist)';
$string['booking:managebulkcheck'] = 'Von der Massenversand-Prüfung zurückgestellte Regel-Mails verwalten';
...
$string['bulkcheckactive'] = 'Diese Regel auf Massenversand prüfen';
$string['bulkcheckactive_help'] = 'Die Mails dieser Regel werden zurückgestellt und gestoppt, wenn ungewöhnlich viele davon auf einmal rausgehen sollen. Die Mails warten dann, bis jemand sie verschickt oder löscht. Wie lange zurückgestellt wird und über welchen Zeitraum gezählt wird, ist für alle Regeln gleich und wird in den Plugin-Einstellungen festgelegt.';
$string['bulkcheckactive_label'] = 'Die Mails dieser Regel stoppen, wenn zu viele auf einmal rausgehen';
$string['bulkcheckblockedbody'] = 'Die Regel "{$a->rule}" wollte {$a->count} Mails verschicken. Das ist mehr als das eingestellte Limit von {$a->limit} pro {$a->period}, daher wurde keine davon verschickt. Sie sind zurückgestellt und warten auf eine Entscheidung: {$a->link}';
$string['bulkcheckblockedsubject'] = 'Massenversand blockiert: {$a->rule}';
$string['bulkcheckdelay'] = 'Massenversand-Prüfung: Verzögerung';
$string['bulkcheckdelay_desc'] = 'Wie lange eine geprüfte Mail zurückgehalten wird, damit sich der Rest des Massenversands ansammeln kann, bevor etwas verschickt wird. Eine Buchungsregel reiht ihren gesamten Massenversand in einem Durchgang ein, daher muss das nur diesen Durchgang plus einen Cron-Lauf abdecken: zwei Minuten reichen für die meisten Websites. Höher stellen, wenn eine Regel auf einmal mehr als ein paar tausend Personen anschreiben kann. Dauert das Einreihen länger als diese Zeit, oder ist sie auf null gestellt, geht höchstens das Limit raus, bevor der Rest gestoppt wird.';
$string['bulkcheckdeletedoption'] = 'gelöschte Buchungsoption #{$a}';
$string['bulkcheckdeletedrule'] = 'gelöschte Regel #{$a}';
$string['bulkcheckdismissall'] = 'Alle {$a} löschen';
$string['bulkcheckdismissallbody'] = 'Jede zurückgestellte Mail dieser Liste wird gelöscht und nie verschickt - nicht nur die auf dem Bildschirm. Filter und Suche werden dabei nicht berücksichtigt.';
$string['bulkcheckdismissbody'] = 'Diese Mails werden nie verschickt: <br> "{$a->data}"';
$string['bulkcheckdismissed'] = '{$a} Mail(s) wurden verworfen. Sie werden nicht verschickt.';
$string['bulkcheckdismissselected'] = 'Ausgewählte löschen';
$string['bulkcheckdismisssubmit'] = 'Löschen';
$string['bulkcheckdismisstitle'] = 'Diese zurückgestellten Mails verwerfen?';
$string['bulkcheckduecolumn'] = 'Fällig';
$string['bulkcheckemailcolumn'] = 'E-Mail';
$string['bulkcheckenabled'] = 'Regel-Mails auf Massenversand prüfen';
$string['bulkcheckenabled_desc'] = 'Mails von Buchungsregeln, für die die Massenversand-Prüfung eingestellt ist, werden zurückgestellt und gestoppt, wenn ungewöhnlich viele davon auf einmal verschickt werden sollen. Die gestoppten Mails warten auf eine manuelle Freigabe und die eingestellten Nutzer:innen werden informiert. Geprüft werden nur Mails, die von Buchungsregeln verschickt werden; von Hand verschickte Nachrichten, Umfrage-Links und Warteliste-Mails nicht. Solange diese Einstellung aus ist, werden alle Regel-Mails sofort verschickt.';
$string['bulkchecklimit'] = 'Erlaubte Sendungen pro Zeitraum';
$string['bulkchecknotifyusers'] = 'Wer über einen blockierten Massenversand informiert wird';
$string['bulkchecknotifyusers_desc'] = 'Diese Nutzer:innen erhalten die Warnung, wenn ein Massenversand blockiert wird, und die tägliche Erinnerung, solange Mails zurückgestellt sind. Leer lassen, um alle Administrator:innen zu informieren.';
$string['bulkcheckoldestcolumn'] = 'Wartet';
$string['bulkcheckoptioncolumn'] = 'Buchungsoption';
$string['bulkcheckparked'] = 'Zurückgestellte Regel-Mails';
$string['bulkcheckparkeddescription'] = 'Mails verschicken oder löschen, die die Massenversand-Prüfung gestoppt hat';
$string['bulkcheckparkedintro'] = 'Diese Mails wurden gestoppt, weil zu viele davon auf einmal rausgehen sollten. Wählen Sie die aus, die doch rausgehen sollen, und verschicken Sie sie - oder erledigen Sie die ganze Liste auf einmal. Eine freigegebene Mail wird vor dem Versand noch einmal geprüft: Wurde ihre Regel inzwischen geändert oder gelöscht, wird sie nicht verschickt.';
$string['bulkcheckparkedwarning'] = '{$a} Mail(s) wurden von der Massenversand-Prüfung zurückgestellt und warten auf eine Entscheidung.';
$string['bulkcheckperiod'] = 'Massenversand-Prüfung: Zeitraum';
$string['bulkcheckperiod_desc'] = 'Der Zeitraum, über den die Sendungen einer Regel gezählt werden. Wird das Limit darin überschritten, wird der gesamte Massenversand zurückgestellt statt verschickt.';
$string['bulkcheckreleaseall'] = 'Alle {$a} verschicken';
$string['bulkcheckreleaseallbody'] = 'Jede zurückgestellte Mail dieser Liste wird verschickt - nicht nur die auf dem Bildschirm. Filter und Suche werden dabei nicht berücksichtigt. Mails, deren Regel inzwischen geändert oder gelöscht wurde, werden nicht verschickt.';
$string['bulkcheckreleasebody'] = 'Diese Mails werden verschickt: <br> "{$a->data}"';
$string['bulkcheckreleasequeued'] = '{$a} Mail(s) eingereiht. Sie gehen mit dem nächsten Cron-Lauf raus.';
$string['bulkcheckreleasesubmit'] = 'Verschicken';
$string['bulkcheckreleasetitle'] = 'Diese zurückgestellten Mails doch verschicken?';
$string['bulkcheckreminderbody'] = '{$a->total} Mail(s) in {$a->bursts} Massenversand(en) sind noch zurückgestellt und wurden nicht verschickt. Geben Sie sie frei, wenn sie doch rausgehen sollen, oder löschen Sie sie, um diese Erinnerung zu beenden.';
$string['bulkcheckreminderline'] = '{$a->rule} (Regel {$a->ruleid}): {$a->parked} zurückgestellt, wartet seit {$a->waiting}';
$string['bulkcheckremindersubject'] = '{$a->total} Regel-Mail(s) weiterhin zurückgestellt';
$string['bulkcheckrulecolumn'] = 'Regel';
$string['bulkcheckscopedintro'] = 'Es werden nur die zurückgestellten Mails der Regel "{$a}" angezeigt, und die beiden Schaltflächen, die auf alles wirken, wirken nur auf diese Regel.';
$string['bulkchecksendselected'] = 'Ausgewählte verschicken';
$string['bulkcheckshowallrules'] = 'Alle zurückgestellten Mails anzeigen';
$string['bulkcheckusercolumn'] = 'Empfänger:in';
$string['bulkcheckwaiting'] = 'seit {$a}';
...
$string['cachedef_bulkcheckconfig'] = 'Massenversand-Prüfung: Konfiguration (Cache)';
$string['cachedef_bulkcheckmails'] = 'Massenversand-Prüfung: zurückgestellte Mails (Cache)';
...
$string['eventbulkcheckblocked'] = 'Regel-Mail von der Massenversand-Prüfung zurückgestellt';
$string['eventbulkcheckdismissed'] = 'Zurückgestellte Regel-Mails gelöscht';
$string['eventbulkcheckreleased'] = 'Zurückgestellte Regel-Mails freigegeben';
...
$string['messageprovider:bulkchecknotification'] = 'Warnung der Massenversand-Prüfung';
...
$string['privacy:metadata:booking_bulk_check'] = 'Eingereihte und zurückgestellte Regel-Mails der Massenversand-Prüfung';
$string['privacy:metadata:booking_bulk_check:optionid'] = 'Die Buchungsoption, um die es in der Mail geht';
$string['privacy:metadata:booking_bulk_check:ruleid'] = 'Die Buchungsregel, die die Mail eingereiht hat';
$string['privacy:metadata:booking_bulk_check:scheduledtime'] = 'Wann die Mail rausgehen soll';
$string['privacy:metadata:booking_bulk_check:status'] = 'Ob die Mail eingereiht, zurückgestellt, freigegeben oder verschickt ist';
$string['privacy:metadata:booking_bulk_check:userid'] = 'Empfänger:in der Mail';
...
$string['taskbulkcheckcleanup'] = 'Buchung: Massenversand-Prüfung aufräumen';
$string['taskbulkcheckreminder'] = 'Buchung: an zurückgestellte Regel-Mails erinnern';
