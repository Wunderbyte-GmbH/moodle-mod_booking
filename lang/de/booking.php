...
$string['slot_bookings_display_mode_availableforuser'] = 'Anzahl der noch verfügbaren Slots anzeigen';
...
$string['slot_cart_numslots'] = 'Anzahl der Slots: {$a}';
...
$string['slot_error_teacher_required'] = 'Bitte wählen Sie eine Prüfer:in aus.';
...
$string['slot_legend_available'] = 'Verfügbar';
...
$string['slot_max_slots_per_user_help'] = 'Die maximale Anzahl an Slots, die eine Person in EINER einzelnen Buchung buchen kann. Sobald "Wiederbuchung erlauben" eine neue Buchung zulässt, beginnt dieses Kontingent wieder bei null: Die Slots der früheren Buchung bleiben gebucht und ihre Zeiträume weiterhin reserviert, zählen aber nicht mehr auf dieses Limit. Ist "Wiederbuchung erlauben" deaktiviert, ist gar keine zweite Buchung möglich, womit dieser Wert der Gesamtzahl an Slots entspricht, die eine Person halten kann.';
...
$string['slot_overview_heading'] = 'Slot-Verfügbarkeit';
...
$string['slot_price_legend'] = 'Preis-Legende';
$string['slot_price_legend_free'] = 'Kostenlos';
...
$string['slot_release_action'] = 'Slot stornieren';
$string['slot_release_cart_refused'] = 'Diese Buchung kann nicht storniert werden: {$a}';
$string['slot_release_confirm_body'] = 'Willst du den Slot "{$a}" wirklich stornieren? Das kann nicht rückgängig gemacht werden.';
$string['slot_release_confirm_title'] = 'Slot stornieren';
$string['slot_release_error_title'] = 'Dieser Slot kann nicht storniert werden';
$string['slot_release_policy_blocked'] = 'Das Stornieren von Slots ist bei dieser Buchungsoption nicht möglich.';
...
$string['slot_selection_count'] = '{$a->count} von {$a->max} ausgewählt';
$string['slot_selection_gotoday'] = 'Diesen Tag im Kalender anzeigen';
$string['slot_selection_remove'] = 'Diesen Slot aus der Auswahl entfernen';
$string['slot_selection_selectedday'] = 'An diesem Tag ausgewählte Slots';
$string['slot_selection_summary_heading'] = 'Ausgewählte Slots';
$string['slot_selection_total'] = 'Gesamt';
...
$string['slot_update_confirm_cancel_all'] = 'Diese Buchung wird damit vollständig storniert.';
...
$string['slot_update_success_cancelled'] = 'Ihre Buchung wurde storniert.';
$string['slot_update_success_moved'] = 'Ihr Termin wurde auf {$a} verschoben.';
$string['slot_update_success_updated'] = 'Ihre Buchung wurde aktualisiert.';
...
$string['slotsbooked'] = 'Gebuchte Slots aus einem Slot-gebucht-Ereignis, sonst die gebuchten Slots der Buchung (z. B. in der Buchungsbestätigung).';
