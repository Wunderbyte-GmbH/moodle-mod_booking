...
$string['maxoptionsfromcategory'] = 'Anzahl der Buchungen pro in einer Kategorie eingeschränkbar machen?';
...
$string['ruletemplateconfirmwaitinglistbody'] = "<p>Sehr geehrte/r {firstname} {lastname},<br>Sie befinden sich auf der Warteliste<br>{bookingdetails}<br>Alles Gute!</p>";
...
$string['ruletemplatecourseupdatebody'] = "<p>Das ist neu:<br>{changes}<br>Klicken Sie auf den folgenden Link um die Änderung(en) und eine Übersicht über alle Buchungen zu sehen: {bookinglink}</p>";
...
$string['ruletemplatedaysbeforebody'] = "<p>Ihre Buchung startet in einigen Tagen:{bookingdetails} <br> Name: {participant} <br> Um eine Übersicht über alle Buchungen zu erhalten, klicken Sie auf den folgenden Link:{bookinglink}<br> Hier geht's zum Kurs: {courselink}</p>";
$string['ruletemplatedaysbeforesubject'] = "Dein Kurs fängt in einigen Tagen an";
$string['ruletemplatetrainerpoll'] = "Template - Trainer/innen Umfrage ";
$string['ruletemplatetrainerpollbody'] = "<p>Bitte nehmen Sie an der Umfrage teil. <br><br>Link zur Umfrage: {pollurlteachers}</p>";
$string['ruletemplatetrainerpollsubject'] = "Umfrage";
$string['ruletemplatetrainerreminder'] = "Template - Trainer/innen Reminder";
$string['ruletemplatetrainerreminderbody'] = "<p>Ihre Kurs startet in einigen Tagen:<br>{bookingdetails}<br>Sie haben {numberparticipants} gebuchte Teilnehmer:innen und {numberwaitinglist} Personen auf der Warteliste.<br>Um eine Übersicht über alle Buchungen zu erhalten, klicken Sie auf den folgenden Link:<br>{bookinglink}<br>Hier geht's zum Kurs: {courselink}</p>";
$string['ruletemplatetrainerremindersubject'] = "Ihr Kurs startet in einigen Tagen";
$string['ruletemplateuserpoll'] = "Template - User Umfrage";
$string['ruletemplateuserpollbody'] = "<p>Bitte nehmen Sie an der Umfrage teil:<br><br>Link zur Umfrage: {pollurl}</p>";
$string['ruletemplateuserpollsubject'] = "Umfrage";
$string['ruletemplateuserstorno'] = "Template - User Storno";
$string['ruletemplateuserstornobody'] = "<p>Hallo {participant},<br>Sie wurden erfolgreich von {title} abgemeldet.</p>";
