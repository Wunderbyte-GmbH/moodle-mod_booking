...
$string['cachedefbookedusertable'] = 'Gebuchte Nutzer:innen-Tabelle (Cache)';
$string['cachedefbookingoptions'] = 'Buchungsoptionen (Cache)';
$string['cachedefbookingoptionsanswers'] = 'Buchungen von Buchungsoptionen (Cache)';
$string['cachedefbookingoptionsettings'] = 'Settings für Buchungsoptionen (Cache)';
$string['cachedefbookingoptionstable'] = 'Tabelle mit gesamten SQL-Abfragen (Cache)';
$string['cachedefcachedbookinginstances'] = 'Buchungsinstanzen (Cache)';
$string['cachedefcachedpricecategories'] = 'Preiskategorien in Booking (Cache)';
$string['cachedefcachedprices'] = 'Standardpreise in Booking (Cache)';
$string['cachedefcachedsemesters'] = 'Semester (Cache)';
$string['cachedefcachedteachersjournal'] = 'Vertretungen & Absagen (Cache)';
$string['cachedefconditionforms'] = 'Condition Forms (Cache)';
$string['cachedefconfirmbooking'] = 'Buchung bestätigt (Cache)';
$string['cachedefcustomformuserdata'] = 'Benutzerdefiniertes Formular - Nutzerdaten (Cache)';
$string['cachedefelectivebookingorder'] = 'Elective booking order (Cache)';
$string['cachedefeventlogtable'] = 'Eventlog-Tabelle (Cache)';
