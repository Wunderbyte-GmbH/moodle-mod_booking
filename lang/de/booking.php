...
$string['agent_booking_verify_field_ticketdesign_failed'] = 'Das Feld „ticketdesign“ konnte nach dem Speichern nicht bestätigt werden. Angefordert „{$a->requested}“, gespeichert „{$a->actual}“.';
...
$string['agent_ticket_feature_disabled'] = 'Eintrittstickets sind auf dieser Website nicht aktiviert. Eine administrierende Person muss zuerst „Eintrittstickets aktivieren“ in den Booking-Website-Einstellungen einschalten.';
$string['agent_ticket_no_design'] = 'Für die Ticket-Einstellungen wird ein Ticket-Design benötigt. Bitte geben Sie mit ticketdesign den Namen der Zertifikatsvorlage an, die als Eintrittsticket verwendet werden soll.';
...
$string['booking:viewticketreport'] = 'Einlass-Übersicht (Dashboard) ansehen';
...
$string['bookingticketcheckinstatus'] = 'Präsenzstatus beim Einlass';
$string['bookingticketcheckinstatus_desc'] = 'Der Präsenzstatus, den ein erfolgreicher Ticket-Scan setzt. Bewusst getrennt vom Status halten, der Abschlusszertifikate auslöst, damit ein Einlass kein zweites Zertifikat erzeugt.';
$string['bookingticketcounterhint'] = 'Der Präsenzzähler des Buchungstrackers zählt einen anderen Präsenzstatus als den, der beim Einlass gesetzt wird. Mit dem Scanner eingelassene Termine werden erst gezählt, wenn „Zu zählender Präsenzstatus“ und „Präsenzstatus beim Einlass“ übereinstimmen.';
$string['bookingticketcreatetemplate'] = 'Beispiel-Ticketvorlage';
$string['bookingticketcreatetemplate_desc'] = 'Legt ein fertiges Ticket-Design bei den Zertifikatsvorlagen an. Sie können es anschließend in einer Buchungsoption auswählen oder duplizieren und das Layout anpassen.';
$string['bookingticketcreatetemplatebutton'] = 'Beispiel-Ticketvorlage anlegen';
...
$string['bookingticketon'] = 'Eintrittstickets aktivieren';
$string['bookingticketon_desc'] = 'Wenn aktiviert, steht im Formular der Buchungsoption der Abschnitt „Ticketing“ zur Verfügung. Für jede erfolgreiche Buchung einer Option mit ausgewähltem Ticket-Design wird ein Ticket erstellt.';
$string['bookingticketserialscan'] = 'Serien-Scan-Modus';
$string['bookingticketserialscan_desc'] = 'Nach jedem bestätigten oder abgelehnten Ticket automatisch zur Kamera zurückkehren, damit eine Warteschlange ohne weitere Interaktion gescannt werden kann. Wenn deaktiviert, stoppt der Scanner nach jedem Ticket.';
...
$string['buttonlabelwithprice'] = '{$a->label} (Preis: {$a->price})';
...
$string['datasource:bookingmessages'] = 'Gesendete Buchungsnachrichten';
...
$string['editoptionsrequirecourselogin'] = 'Kurs-Login für das Bearbeiten von Buchungsoptionen erforderlich';
...
$string['entity:recipient'] = 'Empfangende Person';
$string['entity:sender'] = 'Absendende Person';
$string['entity:supervisor'] = 'Vorgesetzte/r';
$string['entitybookinganswer'] = 'Buchungsantwort';
$string['entitybookingmessage'] = 'Buchungsnachricht';
...
$string['issupervisor'] = 'Ist Vorgesetzte/r';
...
$string['messagetype:cancelledbyparticipant'] = 'Storniert durch Teilnehmende';
$string['messagetype:cancelledbyteacherorsystem'] = 'Storniert durch Lehrende oder System';
$string['messagetype:changenotification'] = 'Änderungsbenachrichtigung';
$string['messagetype:completed'] = 'Buchungsoption abgeschlossen';
$string['messagetype:confirmation'] = 'Buchungsbestätigung';
$string['messagetype:custommessage'] = 'Individuelle Nachricht (Buchungsregel)';
$string['messagetype:pollurlparticipant'] = 'Umfrage-Link für Teilnehmende';
$string['messagetype:pollurlteacher'] = 'Umfrage-Link für Lehrende';
$string['messagetype:reminderparticipant'] = 'Erinnerung an Teilnehmende';
$string['messagetype:reminderteacher'] = 'Erinnerung an Lehrende';
$string['messagetype:reportreminder'] = 'Erinnerung aus dem Bericht';
$string['messagetype:sessionreminder'] = 'Termin-Erinnerung';
$string['messagetype:statuschanged'] = 'Statusänderung';
$string['messagetype:unknown'] = 'Unbekannter Nachrichtentyp';
$string['messagetype:waitinglist'] = 'Wartelistenbestätigung';
...
$string['mytaughtcourselist'] = 'Zeige die Buchungsoptionen, die ich unterrichte.';
$string['mytickets'] = 'Meine Tickets';
$string['myticketsnone'] = 'Sie haben noch keine Tickets.';
$string['name'] = 'Name';
...
$string['noticketselected'] = 'Kein Ticket-Design ausgewählt';
...
$string['previewlabel_ticketconfirmidentity'] = 'Identitätsprüfung verlangen';
...
$string['privacy:metadata:bookingtickets'] = 'Eintrittstickets zu Buchungen, inklusive eines Daten-Snapshots für das Ticket-PDF';
$string['privacy:metadata:bookingtickets:answerid'] = 'ID der Buchungsantwort, für die das Ticket erstellt wurde';
$string['privacy:metadata:bookingtickets:code'] = 'Eindeutiger Verifikationscode des Tickets, im QR-Code enthalten';
$string['privacy:metadata:bookingtickets:json'] = 'Snapshot der Buchungsoptions- und Nutzerdaten (z.B. voller Name) bei Ticketerstellung, zum Rendern des PDFs';
$string['privacy:metadata:bookingtickets:optionid'] = 'ID der Buchungsoption des Tickets';
$string['privacy:metadata:bookingtickets:personalized'] = 'Ob das Ticket nur für die eingetragene Person gültig ist';
$string['privacy:metadata:bookingtickets:status'] = 'Ob das Ticket gültig oder storniert ist';
$string['privacy:metadata:bookingtickets:timecreated'] = 'Zeitpunkt der Ticketerstellung';
$string['privacy:metadata:bookingtickets:timemodified'] = 'Zeitpunkt der letzten Änderung';
$string['privacy:metadata:bookingtickets:timerevoked'] = 'Zeitpunkt der Stornierung';
$string['privacy:metadata:bookingtickets:userid'] = 'ID der Person, die das Ticket besitzt';
...
$string['sendticket'] = 'Ticket senden';
$string['sendticket_desc'] = 'Sendet das Eintrittsticket der Buchungsoption an die ausgewählten Personen, mit dem Ticket-PDF im Anhang.';
...
$string['signinsheetcolumndate'] = '{$a->day}. {$a->month}';
$string['signinsheetcolumndatetime'] = '{$a->day}. {$a->monthabbr}, {$a->time}';
...
$string['statuscheckedin'] = "Eingelassen";
...
$string['tasksendticketbyruleadhoc'] = 'Booking: Ticket via Regel versenden (Adhoc-Task)';
...
$string['ticket'] = 'Ticket-Design';
$string['ticket_help'] = 'Die Zertifikatsvorlage, die als Layout für das Eintrittsticket verwendet wird. Leer lassen, wenn für diese Buchungsoption keine Tickets erstellt werden sollen.';
$string['ticketalreadypresent'] = 'Bereits eingelassen um {$a}';
$string['ticketbutton'] = 'Ticket';
$string['ticketbuttoncolumn'] = 'Ticket (Download-Button)';
$string['ticketcode'] = 'Ticket-Code';
$string['ticketconfiguredviarule'] = 'Tickets werden automatisch erstellt, sobald jemand diese Option bucht. Für den Versand legen Sie eine Buchungsregel an, die auf das Ereignis „Eintrittsticket erstellt“ reagiert und die Aktion „Ticket senden“ verwendet.';
$string['ticketconfirmentry'] = 'Einlass bestätigen';
$string['ticketconfirmidentity'] = 'Identitätsprüfung verlangen';
$string['ticketconfirmidentity_help'] = 'Wenn aktiviert, zeigt der Scanner die Identitätsdaten der Person (wie in den Website-Einstellungen konfiguriert) auch bei nicht personalisierten Tickets an, und der Einlass wird erst gespeichert, nachdem das Einlasspersonal die Person an der Tür ausdrücklich bestätigt hat. Sinnvoll für Prüfungen und andere Veranstaltungen mit Identitätspflicht. Ist weder diese Option noch „Personalisiertes Ticket“ aktiviert, wird beim Scan sofort eingelassen, ohne Bestätigung durch das Einlasspersonal.';
$string['ticketconfirmidentitylabel'] = 'Identitätsdaten immer anzeigen und vor dem Einlass eine ausdrückliche Bestätigung verlangen';
$string['ticketcreated'] = 'Eintrittsticket erstellt';
$string['ticketcreateddesc'] = 'Für die Person mit ID \'{$a->relateduserid}\' wurde für die Buchungsoption mit ID \'{$a->optionid}\' das Eintrittsticket mit ID \'{$a->objectid}\' erstellt.';
$string['ticketdownload'] = 'Ticket herunterladen';
$string['ticketentryrejected'] = 'Einlass verweigert';
$string['ticketextrainfo'] = 'Zusätzliche Ticketinformationen';
$string['ticketextrainfo_help'] = 'Freier Text, der auf dem Ticket gedruckt wird, zum Beispiel Einlassregeln oder Anfahrtshinweise. Damit er sichtbar wird, muss das Ticket-Design ein Feld-Element mit „Zusätzliche Ticketinformationen“ enthalten.';
$string['ticketfilenameprefix'] = 'ticket';
$string['ticketheader'] = 'Ticketing';
$string['ticketholder'] = 'Ticketinhaber:in';
$string['ticketidentityfullname'] = 'Vollständiger Name';
$string['ticketidentitypicture'] = 'Profilbild';
$string['ticketissuedon'] = 'Ausgestellt am';
$string['ticketnofile'] = 'Das Ticket-PDF wurde noch nicht erstellt.';
$string['ticketnotfound'] = 'Kein gültiges Ticket';
$string['ticketpersonalized'] = 'Personalisiertes Ticket';
$string['ticketpersonalized_help'] = 'Ein personalisiertes Ticket gilt nur für die Person, für die es erstellt wurde, und darf nicht weitergegeben oder weiterverkauft werden. Das steht auf der öffentlichen Prüfseite, damit Kaufinteressierte erkennen, dass ein angebotenes Ticket nicht rechtmäßig den Besitzer wechseln kann.';
$string['ticketpersonalizedlabel'] = 'Nur gültig für die registrierte Person';
$string['ticketregenerate'] = 'Ticket neu erstellen';
$string['ticketrejected'] = 'Eintrittsticket abgelehnt';
$string['ticketrejectedinfo'] = 'Die Person mit ID \'{$a->scanner}\' hat das Eintrittsticket von {$a->relateduser} für die Buchungsoption mit ID \'{$a->optionid}\' abgelehnt (Termin-ID \'{$a->optiondateid}\').';
$string['ticketrejectentry'] = 'Ablehnen';
$string['ticketrevoked'] = 'Dieses Ticket wurde am {$a} storniert und ist nicht mehr gültig.';
$string['ticketscanafter'] = 'Scanner verfügbar nach jedem Termin';
$string['ticketscanafter_help'] = 'Wie lange nach Ende jedes Termins dieser Option der Ticket-Scanner verfügbar bleibt. 0 bedeutet unbegrenzt. Optionen ohne Termine können immer gescannt werden.';
$string['ticketscanbefore'] = 'Scanner verfügbar vor jedem Termin';
$string['ticketscanbefore_help'] = 'Wie lange vor Beginn jedes Termins dieser Option der Ticket-Scanner geöffnet ist. 0 bedeutet unbegrenzt. Optionen ohne Termine können immer gescannt werden.';
$string['ticketscanned'] = 'Eintrittsticket gescannt';
$string['ticketscannedinfo'] = 'Die Person mit ID \'{$a->scanner}\' hat {$a->relateduser} per Eintrittsticket für die Buchungsoption mit ID \'{$a->optionid}\' eingelassen (Termin-ID \'{$a->optiondateid}\').';
$string['ticketscanner'] = 'Ticket-Scanner';
$string['ticketscannercheckedin'] = 'Eingelassen';
$string['ticketscannerclose'] = 'Schließen';
$string['ticketscannerclosed'] = 'Der Ticket-Scanner ist für diese Veranstaltung derzeit nicht verfügbar.';
$string['ticketscannerclosednextopen'] = 'Er öffnet am {$a}.';
$string['ticketscannerconfirmprompt'] = 'Bestätigen, um für diesen Termin einzulassen.';
$string['ticketscannercounter'] = 'Eingelassen: {$a->present} / {$a->booked}';
$string['ticketscannerdate'] = 'Termin';
$string['ticketscannerdatepresent'] = '{$a} (eingelassen)';
$string['ticketscannerduplicate'] = 'Gerade eben schon gescannt.';
$string['ticketscannererror'] = 'Ticket konnte nicht geprüft werden. Bitte erneut versuchen.';
$string['ticketscannerforoption'] = 'Tickets scannen für: {$a}';
$string['ticketscannerhttpswarning'] = 'Die Kamera ist nur über eine sichere Verbindung (HTTPS) verfügbar. Das Scannen funktioniert hier nicht.';
$string['ticketscannerinvalid'] = 'Kein gültiges Ticket';
$string['ticketscannerlastscan'] = 'Letzter erfolgreicher Scan';
$string['ticketscannernext'] = 'Weiter';
$string['ticketscannernocamera'] = 'Auf diesem Gerät ist keine Kamera verfügbar.';
$string['ticketscannernodetector'] = 'Dieser Browser kann keine QR-Codes scannen. Verwenden Sie Chrome unter Android oder öffnen Sie den Prüf-Link direkt.';
$string['ticketscannerpermissiondenied'] = 'Kamerazugriff wurde verweigert. Bitte Kamerazugriff erlauben, um Tickets zu scannen.';
$string['ticketscanners'] = 'Zusätzliches Einlasspersonal';
$string['ticketscanners_help'] = 'Personen, die die Tickets dieser Buchungsoption am Einlass scannen dürfen, ohne die Fähigkeit „Eintrittstickets scannen“ zu haben. Sie können nur Personen auswählen, deren Profil Sie sehen dürfen; Personen, die Sie nicht sehen, bleiben beim Speichern in der Liste. Einlasspersonal muss im Kurs eingeschrieben sein, um den Scanner zu öffnen.';
$string['ticketscannerscanning'] = 'Kamera auf den QR-Code des Tickets richten …';
$string['ticketscannerstart'] = 'Scanner starten';
$string['ticketscannerstartprompt'] = 'Auf „Scanner starten“ tippen und Kamerazugriff erlauben.';
$string['ticketscannerstop'] = 'Scanner stoppen';
$string['ticketscannerstopped'] = 'Scanner gestoppt.';
$string['ticketscannerwrongoption'] = 'Dieses Ticket gehört zu einer anderen Veranstaltung: {$a}';
$string['ticketstatuscancelled'] = 'Storniert';
$string['ticketstatusvalid'] = 'Gültig';
$string['tickettemplatecreated'] = 'Die Beispiel-Ticketvorlage „{$a}“ wurde angelegt.';
$string['tickettemplatemissing'] = 'Das gewählte Ticket-Design existiert nicht mehr. Bitte wählen Sie ein anderes.';
$string['tickettemplatename'] = 'Buchungsticket';
$string['tickettitle'] = 'TICKET';
$string['ticketurl'] = 'Download-URL des Tickets';
$string['ticketvalid'] = 'Gültiges Ticket';
$string['ticketverifycancelled'] = 'Dieses Ticket wurde storniert und ist nicht mehr gültig.';
$string['ticketverifyheading'] = 'Eintrittsticket prüfen';
$string['ticketverifyidentityprompt'] = 'Prüfen Sie, ob das die Person vor Ihnen ist.';
$string['ticketverifynotfound'] = 'Zu diesem Code wurde kein gültiges Ticket gefunden.';
$string['ticketverifypersonalizedhint'] = 'Dies ist ein personalisiertes Ticket. Es gilt nur für die Person, für die es erstellt wurde, und kann nicht weitergegeben oder weiterverkauft werden.';
$string['ticketverifystafflogin'] = 'Melden Sie sich als Einlasspersonal an, um diese Person einzulassen.';
$string['ticketverifytransferablehint'] = 'Dieses Ticket ist nicht an eine bestimmte Person gebunden und darf weitergegeben werden.';
$string['ticketverifyurl'] = 'Prüf-URL des Tickets';
$string['ticketverifyvalid'] = 'Dieses Ticket ist gültig.';
