...
$string['waitinglistbookingwindowhours'] = 'Buchungs-Zeitfenster pro Person';
$string['waitinglistbookingwindowhours_desc'] = 'Geben Sie die Dauer in Stunden an, für die es einer Person von der Warteliste möglich ist, einen Platz zu buchen. Ist dieser Wert z.B. auf 24 gesetzt, so kann während der ersten 24 Stunden nach Freiwerden eines Platzes NUR die erstgereihte Person der Warteliste buchen, in den folgenden 24 Stunden NUR die Zweitgereihte. 0 bedeutet, es kann immer nur die erstgereihte Person buchen.';
