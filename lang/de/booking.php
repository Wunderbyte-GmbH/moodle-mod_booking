...
$string['teacherpagevisibilitymode_desc'] = 'Bestimmt, welche versteckten Buchungsoptionen Trainer:innen auf ihrem eigenen öffentlichen Trainerprofil sehen können. Diese Einstellung gilt nicht beim Anzeigen anderer Trainerprofile. Es werden nur Optionen angezeigt, bei denen die Trainer:in zugewiesen ist. Diese Einstellung beeinflusst nicht Benutzer:innen mit der Berechtigung \'canseeinvisibleoptions\', die immer alle versteckten Optionen sehen können';
