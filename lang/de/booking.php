...
$string['slot_rule_active_range'] = 'Gültigkeitszeitraum';
$string['slot_rule_activefrom'] = 'Gültig von';
$string['slot_rule_activeuntil'] = 'Gültig bis';
...
$string['slot_rule_editor_savefirst'] = 'Speichern Sie diese Buchungsoption zuerst, um Slot-Regeln verwalten zu können.';
$string['slot_rule_editor_title'] = 'Slot-Regel-Editor';
$string['slot_rule_error_activerange'] = 'Das Datum "Gültig bis" muss nach dem Datum "Gültig von" liegen.';
$string['slot_rule_existing'] = 'Vorhandene Slot-Regeln';
$string['slot_rule_none'] = 'Für diese Option existieren noch keine Slot-Regeln.';
$string['slot_rule_price_delete_confirm'] = 'Möchten Sie diesen Slot-Regelpreiseintrag wirklich löschen?';
$string['slot_rule_price_deleted'] = 'Slot-Regelpreiseintrag gelöscht.';
$string['slot_rule_price_summary'] = 'Preisauswirkung';
$string['slot_rule_pricecategoryidentifier'] = 'Preiskategorie-Kennung';
$string['slot_rule_pricecurrency'] = 'Währung (optional)';
$string['slot_rule_priceheader'] = 'Preisregel-Details';
...
$string['slot_rule_tables_missing'] = 'Slot-Regel-Tabellen sind noch nicht verfügbar. Bitte führen Sie zuerst das Plugin-Upgrade durch.';
...
$string['slot_rule_type_closed'] = 'Gesperrte Slots';
$string['slot_rule_type_price'] = 'Preisanpassung';
$string['slot_rule_useactiverange'] = 'Auf Gültigkeitszeitraum beschränken';
...
$string['slot_unavailability_helptext'] = 'Wählen Sie Slots aus, die im gewählten Modus markiert werden sollen. Im Verfügbarkeitsmodus bleiben die gewählten Slots verfügbar und alle anderen Slots im Geltungsbereich werden gesperrt.';
...
$string['slot_unavailability_scope_system'] = 'System (alle Buchungen mit dieser Lehrperson)';
