...
$string['caleventtype'] = 'Ereignistyp';
$string['caleventtypeuser'] = 'Benutzer/in';
$string['caleventtypegroup'] = 'Gruppe';
$string['caleventtypecourse'] = 'Kurs';
$string['caleventtypecoursecat'] = 'Kategorie';
$string['caleventtypesite'] = 'Global';
