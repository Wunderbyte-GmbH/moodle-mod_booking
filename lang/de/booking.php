...
$string['bookingticketheading_desc'] = 'Bei erfolgreicher Buchung ein personalisiertes PDF-Ticket mit QR-Code ausstellen, am Einlass prüfen und bei Stornierung entwerten. Benötigt tool_certificate und ein aktives Zertifikat-Template.';
$string['bookingticketon'] = 'Eintrittstickets aktivieren';
$string['bookingticketon_desc'] = 'Wenn aktiviert, wird für jede erfolgreiche Buchung ein Ticket aus dem unten gewählten Master-Template ausgestellt.';
$string['bookingticketsendmail'] = 'Ticket per E-Mail senden';
$string['bookingticketsendmail_desc'] = 'Das Ticket-PDF beim Ausstellen per E-Mail an die Teilnehmer:innen zustellen.';
...
$string['bookingtickettemplate'] = 'Master-Ticket-Template';
$string['bookingtickettemplate_desc'] = 'Das eine globale tool_certificate-Template für alle Eintrittstickets. Das Firmenlogo wird zur Renderzeit aus dem Kursbild geladen – ein Template genügt für alle Mandanten.';
