...
$string['marmara:baseurl'] = 'Basis-URL';
$string['marmara:baseurl_desc'] = 'Die Basis-URL der Marmara Respond API.';
...
$string['marmara:keywordidinfo'] = 'Beim Speichern wird eine ID vergeben';
$string['marmara:keywordparentid'] = 'ID des übergeordneten Kriteriums';
$string['marmara:keywordparentid_desc'] = 'Die ID des übergeordneten Schlüsselworts (Kriterium).';
$string['marmara:keywordparentname'] = 'Name des übergeordneten Kriteriums';
$string['marmara:keywordparentname_desc'] = 'Der Name des übergeordneten Schlüsselworts (Kriterium).';
$string['marmara:marmaraenabled'] = 'Marmara Respond aktivieren';
$string['marmara:marmaraenabled_desc'] = 'Wenn aktiviert, wird das Plugin mit Marmara Respond synchronisiert.';
$string['marmara:marmarasettingsheading'] = 'Marmara Respond Einstellungen';
$string['marmara:marmarasettingsheading_desc'] = 'Konfigurieren Sie unten die Verbindung zu Marmara Respond.';
$string['marmara:secret'] = 'Geheimer Token';
$string['marmara:secret_desc'] = 'Der geheime Token für die Authentifizierung mit Marmara Respond.';
$string['marmara:selectparentkeyword'] = 'Select parent Keyword';
$string['marmara:selectparentkeyword_help'] = 'Wählen Sie ein übergeordnetes Schlüsselwort aus der Liste aus. Dieses wird verwendet, um Schlüsselwörter in Marmara zu gruppieren oder zu organisieren. Wenn kein Schlüsselwort ausgewählt wird, wird standardmäßig das Root-Schlüsselwort verwendet.';
$string['marmara:sync'] = 'Synchronisieren';
