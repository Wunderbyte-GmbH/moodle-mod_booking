...
function xmldb_booking_upgrade($oldversion) {
    ...
    if ($oldversion < 2026090302) {
        ...
        upgrade_mod_savepoint(true, 2026090302, 'booking');
    }
    ...
    if ($oldversion < 2026090303) {
        ...
        upgrade_mod_savepoint(true, 2026090303, 'booking');
    }
    ...
    if ($oldversion < 2026090304) {
        ...
        upgrade_mod_savepoint(true, 2026090304, 'booking');
    }
    ...
    if ($oldversion < 2026090305) {
        ...
        upgrade_mod_savepoint(true, 2026090305, 'booking');
    }
