...
$tasks = [
    ...
    // Bulk send checker: remind about parked mails every day at 07:30 AM.
    ['classname' => 'mod_booking\task\bulk_check_reminder',
        'blocking' => 0,
        'minute' => '30',
        'hour' => '7',
        'day' => '*',
    ...
    // Bulk send checker: tidy up orphaned and stale rows every day at 03:15 AM.
    ['classname' => 'mod_booking\task\bulk_check_cleanup',
        'blocking' => 0,
        'minute' => '15',
        'hour' => '3',
        'day' => '*',
