...
if ((isset($subsribesuccess) && $subsribesuccess) || (isset($unsubscribesuccess) && $unsubscribesuccess)) {
    if (isset($subsribesuccess) && $subsribesuccess) {
        echo $OUTPUT->notification("<h2>" . get_string('bookingsaved', 'booking') . "</h2>", " loginbox notifysuccess");
    }
    if (isset($unsubscribesuccess) && $unsubscribesuccess) {
