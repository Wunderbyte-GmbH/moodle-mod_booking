...
define('MOD_BOOKING_OPTION_FIELD_CONFIRMATION_TRAINER', 392); // 392 to 399 for confirmation workflows.

// Headers.
// define('MOD_BOOKING_HEADER_SKELETON', 'confirmation_trainerheader');
// phpcs:enable
