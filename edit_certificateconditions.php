...
echo html_writer::div(get_string(
    'certificateconditionsettingsdesc',
    'mod_booking',
    (new moodle_url('/mod/booking/edit_certificateconditions.php'))->out()
), 'alert alert-info');

// Check if PRO version is active.
if (wb_payment::pro_version_is_activated()) {
    $rendered = certificate_conditions::get_rendered_list_of_saved_conditions($contextid);
    echo $rendered;
} else {
