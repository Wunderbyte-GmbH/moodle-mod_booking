...
interface bo_condition {
     ...
     */
    public static function is_available(booking_option_settings $settings, $userid, $not);
     ...
     *   this item
     */
    public static function get_description($full, booking_option_settings $settings, $userid, $not);
}
