...
class userprofilefield_1_default implements bo_condition {
    ...
    public function get_name(): string {
        return get_string('boconduserprofilefield1default', 'mod_booking');
    }
    ...
    public function add_condition_to_mform(MoodleQuickForm &$mform, int $optionid = 0) {
        ...
        $mform->addElement(
            'html',
            '<div id="bo_cond_userprofilefield_1_default_restrict_hr" class="d-flex justify-content-end"><hr class="w-75"/></div>'
        );
    }
