 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class confirmaskforconfirmation implements bo_condition {
    /** @var int $id Standard Conditions have hardcoded ids. */
    public $id = MOD_BOOKING_BO_COND_CONFIRMASKFORCONFIRMATION;
    ...
    public function get_name(): string {
        return get_string('bocondconfirmaskforconfirmation', 'mod_booking');
    }
