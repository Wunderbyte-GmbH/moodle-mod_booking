...
class otheroptionsavailable implements bo_condition {
    ...
    public function get_name(): string {
        return get_string('bocondotheroptionsavailable', 'mod_booking');
    }
    ...
    public function is_available(booking_option_settings $settings, int $userid, bool $not = false): bool {
        ...
        if (
            ...
            foreach ($json->boactions as $action) {
                if (
                    $action->action_type != "bookotheroptions"
                    || !isset($action->bookotheroptionsselect)
                ) {
                    continue;
                }
                switch ($action->bookotheroptionsforce) {
    ...
    public function render_button(
        ...
        $label = get_string('otheroptionsnotavailable', 'mod_booking');
    ...
    private function get_description_string(bool $isavailable, bool $full, booking_option_settings $settings) {
        ...
        if ($isavailable) {
            $description = get_string('otheroptionsavailable', 'mod_booking');
        } else {
            $description = get_string('otheroptionsnotavailable', 'mod_booking');
        }
        return $description;
    }
}
