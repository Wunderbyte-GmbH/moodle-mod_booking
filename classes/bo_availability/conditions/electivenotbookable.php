...
class electivenotbookable implements bo_condition {
    ...
    public function get_name(): string {
        return get_string('bocondelectivenotbookable', 'mod_booking');
    }
    ...
    public function is_available(booking_option_settings $settings, int $userid, bool $not = false): bool {
        ...
        if (!empty($booking->iselective)) {
            // If we are in an elective, we have a couple of options.
            $remainingcredits = elective::return_credits_left($booking);
            if ($remainingcredits < $settings->credits) {
                $isavailable = false;
            }
