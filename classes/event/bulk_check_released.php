...
/**
 * A rule mail was released from the bulk send checker.
 *
 * @package mod_booking
...
/**
 * The bulk_check_released event class.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bulk_check_released extends \core\event\base {
    /**
     * Init.
     * @return void
     */
    ...
    public static function get_name() {
        return get_string('eventbulkcheckreleased', 'mod_booking');
    }
    ...
    public function get_description() {
        ...
        return "Released: $count rule mail(s) of booking rule with id '" . $this->other['ruleid'] . "'.";
    }
