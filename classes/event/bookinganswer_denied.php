...
class bookinganswer_denied extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('bookingoptiondenied', 'booking');
    }
    ...
    public function get_description() {
        ...
        return get_string('bookingoptiondenied:description', 'mod_booking', $this->data);
    }
