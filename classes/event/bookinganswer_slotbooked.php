...
/**
 * The bookinganswer_slotbooked event.
 *
 * @package mod_booking
...
/**
 * Event raised when a slot booking answer is created.
 */
class bookinganswer_slotbooked extends \core\event\base {
    /**
     * Init event metadata.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('slot_booked_event_name', 'mod_booking');
    }
    ...
    public function get_description() {
        ...
        return get_string('slot_booked_event_description', 'mod_booking', $a);
    }
