...
class bookingoption_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventbookingoption_completed', 'booking');
    }

    public function get_description() {
        if ($this->userid != $this->data['relateduserid']) {
            return "The user with id {$this->userid} marked the option with id  {$this->objectid} for the user with id {$this->data['other']['userid']} as completed.";
        } else {
