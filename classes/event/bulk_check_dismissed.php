...
/**
 * A rule mail was dismissed from the bulk send checker.
 *
 * @package mod_booking
...
/**
 * The bulk_check_dismissed event class.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bulk_check_dismissed extends \core\event\base {
    /**
     * Init.
     * @return void
     */
    ...
    public static function get_name() {
        return get_string('eventbulkcheckdismissed', 'mod_booking');
    }
    ...
    public function get_description() {
        ...
        return "Dismissed: $count rule mail(s) of booking rule with id '" . $this->other['ruleid'] . "'.";
    }
