...
class booking_option {
     ...
     * @param bool $deletecompleted set this to true if you want to delete a complete answers too
    ...
    public function user_delete_response($userid, $cancelreservation = false,
        $bookingoptioncancel = false, $syncwaitinglist = true, $deletecompleted = false) {
        ...
        $results = $DB->get_records('booking_answers',
                ['userid' => $userid, 'optionid' => $this->optionid, 'completed' => $deletecompleted]);
