...
/**
 * Placeholder for the slot(s) a booking was moved FROM (old slots).
 *
 * @package mod_booking
...
/**
 * Renders the old slot(s) from a slot-moved event payload.
 */
class slotsmovedfrom extends \mod_booking\placeholders\placeholder_base {
    /**
     * Return the formatted old slot list of the triggering event.
     *
    ...
    public static function return_value(
        ...
        return slot_event_placeholders::render($rulejson, ['oldslots']);
    }
