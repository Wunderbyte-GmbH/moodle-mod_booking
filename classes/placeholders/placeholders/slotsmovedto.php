...
/**
 * Placeholder for the slot(s) a booking was moved TO (new slots).
 *
 * @package mod_booking
...
/**
 * Renders the new slot(s) from a slot-moved event payload.
 */
class slotsmovedto extends \mod_booking\placeholders\placeholder_base {
    /**
     * Return the formatted new slot list of the triggering event.
     *
    ...
    public static function return_value(
        ...
        return slot_event_placeholders::render($rulejson, ['newslots', 'bookedslots']);
    }
