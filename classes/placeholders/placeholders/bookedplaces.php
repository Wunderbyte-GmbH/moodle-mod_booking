 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bookedplaces extends \mod_booking\placeholders\placeholder_base {
    /**
    ...
    public static function return_value(
        ...
        // Used -1 to always access array correctly.
        $freetobook = $ba->return_all_booking_information(-1);
        return (string) $freetobook['notbooked']['booked'];
    }
