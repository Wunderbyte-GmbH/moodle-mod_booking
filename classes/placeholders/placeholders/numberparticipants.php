 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class numberparticipants extends \mod_booking\placeholders\placeholder_base {
    /**
    ...
    public static function return_value(
        ...
        if (!empty($optionid)) {
            ...
            $value = !empty($settings->maxanswers)
                ? $settings->maxanswers : get_string('unlimitedplaces', 'mod_booking');
