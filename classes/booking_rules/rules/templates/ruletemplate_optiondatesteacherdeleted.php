...
/**
 * Template for rule to be executed when a teacher is added
 * to a specific optiondate.
 *
 * @package mod_booking
 ...
 */
class ruletemplate_optiondatesteacherdeleted {
    /** @var int $templateid */
    public static $templateid = 16;
    ...
    public static function get_name() {
        return get_string('template', 'mod_booking') . ' - ' . get_string('optiondatesteacherdeleted', 'mod_booking');
    }
    ...
    public static function return_template() {
        ...
        $rulejson = (object)[
            ...
            "actiondata" => [
                "subject" => get_string('optiondatesteacherdeleted', 'mod_booking'),
                "template" => get_string('optiondatesteacherdeleted', 'mod_booking') . ": {optiondatefromevent}",
                "templateformat" => "1",
            ],
