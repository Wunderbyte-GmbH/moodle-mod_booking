 ...
 */
class ruletemplate_daysbeforestart {
    /** @var int $templateid */
    public static $templateid = 3;
    ...
    public static function get_name() {
        return get_string('ruletemplatedaysbefore', 'booking');
    }
    ...
    public static function return_template() {
        ...
        $rulejson = (object)[
            ...
            "actiondata" => [
                "subject" => get_string('ruletemplatedaysbeforesubject', 'booking'),
                "template" => get_string('ruletemplatedaysbeforebody', 'booking'),
                "templateformat" => "1",
            ],
