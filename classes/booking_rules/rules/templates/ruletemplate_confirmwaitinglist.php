 ...
 */
class ruletemplate_confirmwaitinglist {
    /** @var int $templateid */
    public static $templateid = 2;
    ...
    public static function get_name() {
        return get_string('ruletemplateconfirmwaitinglist', 'booking');
    }
    ...
    public static function return_template() {
        ...
        $rulejson = (object)[
            ...
            "actiondata" => [
                "subject" => get_string('ruletemplateconfirmwaitinglistsubject', 'booking'),
                "template" => get_string('ruletemplateconfirmwaitinglistbody', 'booking'),
                "templateformat" => "1",
            ],
