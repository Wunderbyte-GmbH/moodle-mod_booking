 ...
 */
class ruletemplate_trainerpoll {
    /** @var int $templateid */
    ...
    public static function get_name() {
        return get_string('ruletemplatetrainerpoll', 'booking');
    }
    ...
    public static function return_template() {
        ...
        $rulejson = (object)[
            ...
            "actiondata" => [
                "subject" => get_string('ruletemplatetrainerpollsubject', 'booking'),
                "template" => get_string('ruletemplatetrainerpollbody', 'booking'),
                "templateformat" => "1",
            ],
