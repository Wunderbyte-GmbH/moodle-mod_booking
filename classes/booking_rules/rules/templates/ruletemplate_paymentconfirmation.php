 ...
 */
class ruletemplate_paymentconfirmation {
    /** @var int $templateid */
    ...
    public static function get_name() {
        return get_string('ruletemplatepaymentconfirmation', 'booking');
    }
    ...
    public static function return_template() {
        ...
        $rulejson = (object)[
            ...
            "actiondata" => [
                "subject" => get_string('ruletemplatepaymentconfirmationsubject', 'booking'),
                "template" => get_string('ruletemplatepaymentconfirmationbody', 'booking'),
                "templateformat" => "1",
            ],
