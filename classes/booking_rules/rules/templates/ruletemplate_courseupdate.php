 ...
 */
class ruletemplate_courseupdate {
    /** @var int $templateid */
    public static $templateid = 6;
    ...
    public static function get_name() {
        return get_string('ruletemplatecourseupdate', 'booking');
    }
    ...
    public static function return_template() {
        ...
        $rulejson = (object)[
            ...
            "actiondata" => [
                "subject" => get_string('ruletemplatecourseupdatesubject', 'booking'),
                "template" => get_string('ruletemplatecourseupdatebody', 'booking'),
                "templateformat" => "1",
            ],
