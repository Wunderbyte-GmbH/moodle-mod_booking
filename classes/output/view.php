...
class view implements renderable, templatable {
    ...
    public function get_rendered_elective_table():array {
        ...
        // Create the table.
        $allbookingoptionstable = new bookingoptions_wbtable('allbookingoptionstable' . $cmid, $booking);
    ...
    public function get_rendered_active_options_table() {
        ...
        // Create the table.
        $activebookingoptionstable = new bookingoptions_wbtable('activebookingoptionstable' . $cmid, $booking);
    ...
    public function get_rendered_my_booked_options_table() {
        ...
        // Create the table.
        $mybookingoptionstable = new bookingoptions_wbtable('mybookingoptionstable' . $cmid, $booking);
    ...
    public function get_rendered_table_for_teacher(int $teacherid,
        ...
        // Create the table.
        $teacheroptionstable = new bookingoptions_wbtable('teacheroptionstable' . $cmid, $booking);
    ...
    public function get_rendered_showonlyone_table(int $optionid) {
        ...
        // Create the table.
        $showonlyonetable = new bookingoptions_wbtable('showonlyonetable' . $cmid, $booking);
    ...
    public function get_rendered_myinstitution_table(string $institution) {
        ...
        // Create the table.
        $myinstitutiontable = new bookingoptions_wbtable('myinstitutiontable' . $cmid, $booking);
    ...
    public function get_rendered_visible_options_table() {
        ...
        // Create the table.
        $visibleoptionstable = new bookingoptions_wbtable('visibleoptionstable' . $cmid, $booking);
    ...
    public function get_rendered_invisible_options_table() {
        ...
        // Create the table.
        $invisibleoptionstable = new bookingoptions_wbtable('invisibleoptionstable' . $cmid, $booking);
