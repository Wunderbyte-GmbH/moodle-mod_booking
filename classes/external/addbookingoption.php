    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'identifier' => new external_value(PARAM_RAW,
                'Unique identifier for booking option', VALUE_DEFAULT, ''),
            'titleprefix' => new external_value(PARAM_RAW,
                'Optional prefix to be shown before title', VALUE_DEFAULT, ''),
            'targetcourseid' => new external_value(PARAM_INT,
                'Id of course where this booking option should be created.', VALUE_DEFAULT, 0),
            'courseid' => new external_value(PARAM_INT,
                'Id of course to book users to.', VALUE_DEFAULT, 0),
            'bookingcmid' => new external_value(PARAM_INT,
                'Moodle id of booking activity.', VALUE_DEFAULT, 0),
            'bookingidnumber' => new external_value(PARAM_RAW,
                'Idnumber identifier of target booking activity.', VALUE_DEFAULT, ''),
            'bookingoptionid' => new external_value(PARAM_INT,
                'Moodle Id of booking option. Allows to update option.', VALUE_DEFAULT, 0),
            'courseidnumber' => new external_value(PARAM_RAW,
                'Idnumber identifier of target course. Overriden by bookingidnumber.', VALUE_DEFAULT, ''),
            'courseshortname' => new external_value(PARAM_RAW,
                'Shortname of target course. Overriden by bookingidnumber.', VALUE_DEFAULT, ''),
            'enroltocourseshortname' => new external_value(PARAM_RAW,
                'Shortname of course uses will be enroled to.', VALUE_DEFAULT, ''),
            'maxanswers' => new external_value(PARAM_INT,
                'Max places', VALUE_DEFAULT, 0),
            'maxoverbooking' => new external_value(PARAM_INT,
                'Max places on waitinglist', VALUE_DEFAULT, 0),
            'minanswers' => new external_value(PARAM_INT,
                'Minimum number of participants', VALUE_DEFAULT, 0),
            'bookingopeningtime' => new external_value(PARAM_RAW,
                'Time until when booking is not yet possible.', VALUE_DEFAULT, ''),
            'bookingclosingtime' => new external_value(PARAM_RAW,
                'Time when booking is not possible anymore.', VALUE_DEFAULT, ''),
            'enrolmentstatus' => new external_value(PARAM_INT,
                '0 enrol at coursestart; 1 enrolment done; 2 immediately enrol', VALUE_DEFAULT, 0),
            ...
            'beforebookedtext' => new external_value(PARAM_RAW,
                'Before booked text', VALUE_DEFAULT, ''),
            'beforecompletedtext' => new external_value(PARAM_RAW,
                'Text to show before completion.', VALUE_DEFAULT, ''),
            'aftercompletedtext' => new external_value(PARAM_RAW,
                'Text to show after completion.', VALUE_DEFAULT, ''),
            'shorturl' => new external_value(PARAM_URL,
                'Add short url for this option.', VALUE_DEFAULT, ''),
            'duration' => new external_value(PARAM_INT,
                'Duration', VALUE_DEFAULT, 0),
            'useremail' => new external_value(PARAM_EMAIL,
                'Email of user to inscribe. User must exist in system.', VALUE_DEFAULT, ''),
            'teacheremail' => new external_value(PARAM_EMAIL,
                'Email of teacher. User must exist in system.', VALUE_DEFAULT, ''),
            'user_username' => new external_value(PARAM_RAW,
                'Username of user to inscribe. User must exist in system.', VALUE_DEFAULT, ''),
            'coursestarttime' => new external_value(PARAM_TEXT,
                'Time when booking option starts.', VALUE_DEFAULT, ''),
            'courseendtime' => new external_value(PARAM_TEXT,
                'Time when booking option ends.', VALUE_DEFAULT, ''),
            'invisible' => new external_value(PARAM_INT,
                'Default is 0 and visible. 1 will make the option invisible to students.', VALUE_DEFAULT, 0),
            'responsiblecontact' => new external_value(PARAM_RAW,
                'Responsible contact as e-mail. Only one possible.', VALUE_DEFAULT, ''),
            'boavenrolledincourse' => new external_value(PARAM_RAW,
                'Booking Condition enrolled courses with shortnames, comma separated', VALUE_DEFAULT, ''),
