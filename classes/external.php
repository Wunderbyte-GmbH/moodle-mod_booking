...
class external extends external_api {
    ...
    public static function addbookingoption(
        ...
        $cleanedarray = array_filter($params, function($x) { return $x !== null; });
    ...
    public static function addbookingoption_parameters() {
        return new external_function_parameters(
                array(
                        ...
                        'enrolmentstatus' => new external_value(PARAM_INT, '0 enrol at coursestart; 1 enrolment done; 2 immediately enrol',VALUE_DEFAULT, null),
                        ...
                        'limitanswers' => new external_value(PARAM_INT, 'Only limited number of answeres allowed',VALUE_DEFAULT, 0),
                        'addtocalendar' => new external_value(PARAM_INT, 'To add to calendar set to 1, else 0.',VALUE_DEFAULT, null),
                        'pollurl' => new external_value(PARAM_URL, 'Poll url',VALUE_DEFAULT, null),
                        'location' => new external_value(PARAM_RAW, 'Location',VALUE_DEFAULT, null),
                        'institution' => new external_value(PARAM_RAW, 'Institution',VALUE_DEFAULT, null),
                        'address' => new external_value(PARAM_RAW, 'Address',VALUE_DEFAULT, null),
                        'pollurlteachers' => new external_value(PARAM_URL, 'Poll url for teachers',VALUE_DEFAULT, null),
                        'howmanyusers' => new external_value(PARAM_INT, 'How many users',VALUE_DEFAULT, null),
                        'removeafterminutes' => new external_value(PARAM_INT, 'Time to remove booking option in minutes.',VALUE_DEFAULT, null),
                        'notificationtext' => new external_value(PARAM_TEXT, 'Notification text',VALUE_DEFAULT, null),
                        'notificationtextformat' => new external_value(PARAM_INT, 'Notification text format',VALUE_DEFAULT, null),
                        'disablebookingusers' => new external_value(PARAM_INT, 'Set to 1 to disable booking, else 0.',VALUE_DEFAULT, 0),
                        'beforebookedtext' => new external_value(PARAM_INT, 'Max waintinglist',VALUE_DEFAULT, null),
                        'beforecompletedtext' => new external_value(PARAM_TEXT, 'Text to show before completion.',VALUE_DEFAULT, null),
                        'aftercompletedtext' => new external_value(PARAM_TEXT, 'Text to show after completion.',VALUE_DEFAULT, null),
                        'shorturl' => new external_value(PARAM_URL, 'Add short url for this option.',VALUE_DEFAULT, null),
                        'duration' => new external_value(PARAM_INT, 'Duration',VALUE_DEFAULT, 0),
                        'useremail' => new external_value(PARAM_EMAIL, 'Email of user to inscribe. User must exist in system.',VALUE_DEFAULT, null),
                        'teacheremail' => new external_value(PARAM_INT, 'Email of teacher. User must exist in system.',VALUE_DEFAULT, null),
                        'user_username' => new external_value(PARAM_RAW, 'Username of user to inscribe. User must exist in system.',VALUE_DEFAULT, null),
                        'coursestarttime' => new external_value(PARAM_RAW, 'Time when booking option starts.',VALUE_DEFAULT, null),
                        'courseendtime' => new external_value(PARAM_RAW, 'Time when booking option ends.',VALUE_DEFAULT, null),
                        'ismultisession' => new external_value(PARAM_INT, 'To upload multisession in consecutive steps. 0 is no multisession, 1 is create ms, 2 is merge with previous.',VALUE_DEFAULT, null),
                )
        );
    }
