    ...
    public static function verify_common_fields_structured(array $input, object $settings): array {
        ...
        if (array_key_exists('text', $input)) {
            ...
            if ($requested !== '' && !self::equals_ci($requested, $actual)) {
                self::add_failure(
                    ...
                    get_string('agent_booking_verify_field_text_failed', 'bookingextension_agent', (object)[
                        'requested' => $requested,
                        'actual' => $actual,
                    ]),
            ...
            if ($requested !== '') {
                ...
                if (!$matched) {
                    self::add_failure(
                        ...
                        get_string('agent_booking_verify_field_location_failed', 'bookingextension_agent', (object)[
                            'requested' => $requested,
                            'actual' => $actual,
                        ]),
                        [
        ...
        if (array_key_exists('address', $input)) {
            ...
            if ($requested !== '' && !self::equals_ci($requested, $actual)) {
                self::add_failure(
                    ...
                    get_string('agent_booking_verify_field_address_failed', 'bookingextension_agent', (object)[
                        'requested' => $requested,
                        'actual' => $actual,
                    ]),
        ...
        if (array_key_exists('description', $input)) {
            ...
            if ($requested !== '' && stripos($actual, $requested) === false) {
                self::add_failure(
                    ...
                    get_string('agent_booking_verify_field_description_failed', 'bookingextension_agent'),
        ...
        if (!empty($input['headerimage_token']) && self::option_header_image_state($settings) === false) {
            self::add_failure(
                ...
                get_string('agent_booking_verify_field_headerimage_failed', 'bookingextension_agent'),
        ...
        if (array_key_exists('maxanswers', $input)) {
            ...
            if ($requested !== $actual) {
                self::add_failure(
                    ...
                    get_string('agent_booking_verify_field_maxanswers_failed', 'bookingextension_agent', (object)[
                        'requested' => $requested,
                        'actual' => $actual,
                    ]),
        ...
        if (array_key_exists('maxoverbooking', $input)) {
            ...
            if ($requested !== $actual) {
                self::add_failure(
                    ...
                    get_string('agent_booking_verify_field_maxoverbooking_failed', 'bookingextension_agent', (object)[
                        'requested' => $requested,
                        'actual' => $actual,
                    ]),
