...
use mod_booking\local\wizard\engine\skill_input_normalizer_interface;
use mod_booking\local\wizard\engine\skill_input_normalizer_provider_interface;
use mod_booking\local\wizard\engine\skill_interface;
use mod_booking\local\wizard\engine\skill_provider_interface;
...
class skill_provider implements
     ...
     * @return null
     */
    public function get_issue_code_provider(): ?\mod_booking\local\wizard\engine\issue_code_provider_interface {
        return null;
    }
