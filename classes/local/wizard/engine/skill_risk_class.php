...
/**
 * Engine alias: binds skill_risk_class to the active AI engine plugin.
 *
...
if (
    !class_exists(skill_risk_class::class, false)
    && !interface_exists(skill_risk_class::class, false)
    && !trait_exists(skill_risk_class::class, false)
) {
    class_alias(
        engine_resolver::fqcn('dto\\skill_risk_class'),
        skill_risk_class::class
    );
}
