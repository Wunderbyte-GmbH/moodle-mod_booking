...
/**
 * Engine alias: binds skill_provider_interface to the active AI engine plugin.
 *
...
if (
    !class_exists(skill_provider_interface::class, false)
    && !interface_exists(skill_provider_interface::class, false)
    && !trait_exists(skill_provider_interface::class, false)
) {
    class_alias(
        engine_resolver::fqcn('interfaces\\skill_provider_interface'),
        skill_provider_interface::class
    );
}
