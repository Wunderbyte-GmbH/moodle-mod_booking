...
/**
 * Engine alias: binds attachment_resolver to the active AI engine plugin.
 *
...
if (
    !class_exists(attachment_resolver::class, false)
    && !interface_exists(attachment_resolver::class, false)
    && !trait_exists(attachment_resolver::class, false)
) {
    class_alias(
        engine_resolver::fqcn('interfaces\\attachment_resolver'),
        attachment_resolver::class
    );
}
