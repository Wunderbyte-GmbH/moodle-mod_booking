...
/**
 * Engine alias: binds skill_input_normalizer_interface to the active AI engine plugin.
 *
...
if (
    !class_exists(skill_input_normalizer_interface::class, false)
    && !interface_exists(skill_input_normalizer_interface::class, false)
    && !trait_exists(skill_input_normalizer_interface::class, false)
) {
    class_alias(
        engine_resolver::fqcn('interfaces\\skill_input_normalizer_interface'),
        skill_input_normalizer_interface::class
    );
}
