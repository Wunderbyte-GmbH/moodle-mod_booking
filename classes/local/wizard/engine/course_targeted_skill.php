...
/**
 * Engine alias: binds course_targeted_skill to the active AI engine plugin.
 *
...
if (
    !class_exists(course_targeted_skill::class, false)
    && !interface_exists(course_targeted_skill::class, false)
    && !trait_exists(course_targeted_skill::class, false)
) {
    class_alias(
        engine_resolver::fqcn('course_targeted_skill'),
        course_targeted_skill::class
    );
}
