...
/**
 * Engine alias: binds base_skill to the active AI engine plugin.
 *
...
if (
    !class_exists(base_skill::class, false)
    && !interface_exists(base_skill::class, false)
    && !trait_exists(base_skill::class, false)
) {
    class_alias(
        engine_resolver::fqcn('base_skill'),
        base_skill::class
    );
}
