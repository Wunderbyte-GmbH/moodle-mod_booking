...
/**
 * Engine alias: binds issue_code_provider_interface to the active AI engine plugin.
 *
...
if (
    !class_exists(issue_code_provider_interface::class, false)
    && !interface_exists(issue_code_provider_interface::class, false)
    && !trait_exists(issue_code_provider_interface::class, false)
) {
    class_alias(
        engine_resolver::fqcn('interfaces\\issue_code_provider_interface'),
