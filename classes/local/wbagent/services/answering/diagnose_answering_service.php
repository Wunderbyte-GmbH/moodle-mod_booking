 ...
 */
class diagnose_answering_service extends base_answering_service {
    /**
    ...
    public function answer_question(
        ...
        return $this->generate_answer($this->build_prompt($question, $diagnosis, $outputlang), $cmid, $userid);
    }
