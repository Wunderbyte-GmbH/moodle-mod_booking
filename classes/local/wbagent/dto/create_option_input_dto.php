...
/**
 * Canonical input DTO for the booking.create_option use-case.
 *
 * @package    mod_booking
...
/**
 * Value object carrying validated input for a create-option request.
 *
 * @package    mod_booking
 * @copyright  2025 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class create_option_input_dto {
    ...
    public static function from_array(array $data): self {
        if (empty($data['text'])) {
            throw new \InvalidArgumentException('Field "text" (option title) is required.');
        }
