 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class waitlistrecycling extends field_base {
    /**
     * This ID is used for sorting execution.
     * @var int
     */
    public static $id = MOD_BOOKING_OPTION_FIELD_WAITLISTRECYCLING;
    ...
    public static function prepare_save_field(
        ...
        $instance = new waitlistrecycling();
    ...
    public static function instance_form_definition(
        ...
        if (!get_config('booking', 'turnoffwaitinglist')) {
            ...
            $mform->addElement(
                'select',
                'waitlistrecycling',
                get_string('waitlistrecycling', 'mod_booking'),
                $waitlistrecyclingoptions
            );
            $mform->setType('waitlistrecycling', PARAM_INT);
            $mform->setDefault('waitlistrecycling', 0);
            $mform->addHelpButton('waitlistrecycling', 'waitlistrecycling', 'mod_booking');
        }
    }
    ...
    public static function set_data(stdClass &$data, booking_option_settings $settings) {
        $data->waitlistrecycling = $settings->waitlistrecycling ?? 0;
    }
}
