...
* Improvement: All external service classes were migrated from the deprecated global externallib.php aliases (external_api & co.) to the core_external namespace, which also makes them unit-testable without process isolation.
