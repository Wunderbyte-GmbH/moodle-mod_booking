...
* Bugfix: The privacy export exports only the options the user actually booked, one entry per answer with the user's own rating, and the complete booking history of the user in the instance. Before, every answer was combined with every option of the instance, the rating could belong to another user, and only the history of the first answer was exported. (Wunderbyte-GmbH/moodle-mod_booking#1583)
