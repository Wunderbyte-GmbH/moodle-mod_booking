## Version 9.7.9 (2026090205)
* Bugfix: The four waiting list progression upgrade steps are anchored above the base version again (2026090202 - 2026090205). After merging MOODLE_405_DEV, whose released version is 2026090200, their previous anchors (2026083101 - 2026083104) were below that base: a site coming from there skipped the creation of booking_waitlist_offers and booking_waitlist_declines, the recycling fields, the legacy chain migration and the waitlistopenmode column, while still reporting the higher version. All steps are guarded (table and field existence checks, idempotent migrations), so sites that already ran them under the old numbers pass through again. (Wunderbyte-GmbH/moodle-mod_booking#1506)
