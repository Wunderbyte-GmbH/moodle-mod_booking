...
* Bugfix: Unloading a subbooking from the shopping cart or cancelling a subbooking that was never booked no longer inserts an artefact row (status "not booked" or "deleted") into booking_subbooking_answers. (Wunderbyte-GmbH/moodle-mod_booking#1584)
