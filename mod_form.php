...
class mod_booking_mod_form extends moodleform_mod {
	...
	function definition() {
     ...
     $mform->addElement('header', 'categoryheader', 'Category');
    $mform->addElement('selectwithlink', 'scaleid', 'Category', $options, null, 
    array('link' => $CFG->wwwroot.'/grade/edit/scale/edit.php?courseid='.$COURSE->id, 'label' => 'Category'));
