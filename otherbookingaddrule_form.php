...
class otherbookingaddrule_form extends moodleform {
    ...
    public function definition() {
        ...
        $bookingoptions = $DB->get_records_sql("SELECT 
    id, text
FROM
    {booking_options}
WHERE
    bookingid = (SELECT 
        ...
        $mform->addElement('select', 'otheroptionid', get_string('selectoptioninotherbooking', 'booking'), $bookingoptionsarray); // Add elements to your form
