...
# mod_booking — User documentation

Index of the user and admin documentation chapters. For developer topics see the [developer guides](../developer-guides/).

| I want to… | Go to… |
|------------|--------|
| Understand how booking messages work | [Booking messages](00_booking_messages/README.md) |
| View and manage all bookings (site, course, instance, option) | [Bookings Tracker](reports/README.md) |
| Understand every section of the booking option form | [Booking option form](booking-option/README.md) |
| Restrict who can book an option | [Booking conditions](booking_conditions/README.md) |
| Send messages and reminders on booking events, course start etc. | [Booking rules](booking_rules/README.md) |
| Customise notification emails with dynamic text | [Placeholders](placeholders/README.md) |
| Embed booking lists on Moodle pages | [Shortcodes](shortcodes/README.md) |
