...
class restore_booking_activity_task extends restore_activity_task {
    ...
    /**
     * Define the restore log rules that will be applied by the {@link restore_logs_processor} when restoring booking logs. It must return one array
    ...
    /**
     * Define the restore log rules that will be applied by the {@link restore_logs_processor} when restoring course logs. It must return one array of
     * {@link restore_log_rule} objects
     * Note this rules are applied when restoring course logs by the restore final task, but are defined here at activity level. All them are rules
