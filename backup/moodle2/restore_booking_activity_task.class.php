...
/**
 * booking restore task that provides all the settings and steps to perform one
...
class restore_booking_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_booking_activity_structure_step('booking_structure', 'booking.xml'));
    }
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('BOOKINGVIEWBYID', '/mod/booking/view.php?id=$1', 'course_module');
     ...
     * booking logs. It must return one array
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('booking', 'update', 'view.php?id={course_module}', '{booking}');
        $rules[] = new restore_log_rule('booking', 'view', 'view.php?id={course_module}', '{booking}');
        $rules[] = new restore_log_rule('booking', 'choose', 'view.php?id={course_module}', '{booking}');
        $rules[] = new restore_log_rule('booking', 'choose again', 'view.php?id={course_module}', '{booking}');
        $rules[] = new restore_log_rule('booking', 'report', 'report.php?id={course_module}', '{booking}');
