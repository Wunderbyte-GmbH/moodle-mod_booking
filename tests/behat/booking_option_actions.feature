...
Feature: Create booking action as admin and ensure they are working as student and view history.
  ...
  Scenario: Booking actions: create bookotheroptions action via DB and book it as students and view history
    ...
    And I should see "B1-Option1" in the "#booked_system_0_options_r1" "css_element"
    And I should see "1/5" in the "#booked_system_0_options_r1" "css_element"
    And I should see "B1-Option2" in the "#booked_system_0_options_r2" "css_element"
    And I should see "1/2" in the "#booked_system_0_options_r2" "css_element"
    And I should see "B2-Option1" in the "#booked_system_0_options_r3" "css_element"
    And I should see "1/1" in the "#booked_system_0_options_r3" "css_element"
    And I should see "B2-Option2" in the "#booked_system_0_options_r4" "css_element"
    And I should see "0/2" in the "#booked_system_0_options_r4" "css_element"
