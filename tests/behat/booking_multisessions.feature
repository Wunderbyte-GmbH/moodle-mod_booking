...
Feature: In a booking create multi session options
  ...
  Scenario: Create session with multiple dates
    ...
    And I click on "Book now" "text" in the ".show.active .card.row" "css_element"
    ...
    ## And I click on "Settings" "icon" in the ".show.active .card.row .action .dropdown:last" "css_element"
    And I click on ".show.active .card.row .action .dropdown .icon.fa-cog" "css_element"
    ## And I follow "Manage option dates"
    ## And I click on ".dropdown-menu.show .fa-calendar-check-o" "css_element"
    And I click on ".show.active .card.row .action dropdown-menu.show .fa-calendar-check-o:last-of-type" "css_element"
