...
Feature: In a booking - create options and assign or substituing teachers
  ...
  Background:
    ...
    And the following "mod_booking > options" exist:
      | booking    | text                      | course | description  | optiondateid_1 | daystonotify_1 | coursestarttime_1 | courseendtime_1 | optiondateid_1 | daystonotify_1 | coursestarttime_2 | courseendtime_2 |
      | My booking | Booking option - Teachers | C1     | Option deskr | 0              | 0              | ## tomorrow ##    | ## +2 days ##   | 0              | 0              | ## +3 days ##     | ## +4 days ##   |
