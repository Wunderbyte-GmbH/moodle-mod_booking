...
Feature: In a course add a booking option and manage its waiting list
  ...
  Scenario: Booking option: validate waiting list labels
    ...
    And I should see "Limited WL, not full" in the "#booked_system_0_r1" "css_element"
    And I should see "1/2" in the "#booked_system_0_r1" "css_element"
    And I should see "Limited WL, full" in the "#booked_system_0_r2" "css_element"
    And I should see "2/2" in the "#booked_system_0_r2" "css_element"
    And I should see "Unlimited WL, not full" in the "#booked_system_0_r3" "css_element"
    And I should see "1/2" in the "#booked_system_0_r3" "css_element"
    And I should see "Unlimited WL, full" in the "#booked_system_0_r4" "css_element"
    And I should see "2/2" in the "#booked_system_0_r4" "css_element"
