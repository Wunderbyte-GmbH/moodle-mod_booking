...
Feature: In a booking instance create booking options
  ...
  Scenario: Create booking option via DB than edit it and review changes as a teacher
    ...
    And I should see "[NEW] Option-updated" in the "#showEventList" "css_element"
    And I should see "[NEW] 20 June 2050" in the "#showEventList" "css_element"
    And I should see "[NEW] 25 July 2050" in the "#showEventList" "css_element"
