...
Feature: In a booking instance create booking options
  ...
  Scenario: Create booking option via DB than edit it and review changes as a teacher
    ...
    And I should see "Titel has/have changed:" in the "#showEventList" "css_element"
    ...
    And I should see "Dates has/have changed" in the "#showEventList" "css_element"
    ...
    And I should see "Description has/have changed:" in the "#showEventList" "css_element"
    ...
    And I should see "Limit for answers has/have changed:" in the "#showEventList" "css_element"
    And I should see "Teachers has/have changed:" in the "#showEventList" "css_element"
