...
class booking_option_bookit_test extends advanced_testcase {
    ...
    public function test_booking_bookit() {
        ...
        $record->coursestarttime = date('Y-m-d', strtotime('now - 2 day'));
        $record->courseendtime = date('Y-m-d', strtotime('now + 2 day'));
     ...
     * @throws \dml_exception
     */
    public function test_booking_bookit_policy_max_number() {
        global $DB, $CFG;
