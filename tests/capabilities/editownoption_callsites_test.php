...
/**
 * Tests for the call sites of mod/booking:editownoption and whether they
...
/**
 * editownoption is documented as "edit your own options", but only some of
 * its call sites pair it with booking_check_if_teacher(). Every test here uses
 * the SAME user - holding editownoption, teacher of NO option - against an
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class editownoption_callsites_test extends capability_testcase {
    /**
    ...
    public function test_option_form_gate_checks_ownership(): void {
        ...
        $this->assertFalse(
            ...
            'editoptions.php pairs editownoption with booking_check_if_teacher().'
        );
    ...
    public function test_options_list_edit_menu_checks_ownership(): void {
        ...
        $this->assertStringNotContainsString(
            ...
            'The edit menu pairs editownoption with booking_check_if_teacher().'
        );
    }
    ...
    public function test_option_detail_view_checks_ownership(): void {
        ...
        $this->assertEmpty(
            $otherdata['editurl'],
            'The detail view pairs editownoption with booking_check_if_teacher().'
        );
    }
    ...
    public function test_customfield_configuration_does_not_check_ownership(): void {
        ...
        $this->user_with(['mod/booking:editownoption'], \context_system::instance());
    ...
    public function test_webservice_gate_does_not_check_ownership(): void {
        ...
        $this->user_with([]);
        $this->assertFalse(permissions::has_capability_anywhere('mod/booking:editownoption'));

        $this->user_with(['mod/booking:editownoption']);
        $this->assertTrue(
            permissions::has_capability_anywhere('mod/booking:editownoption'),
     ...
     * the logged in user holding only editownoption.
     *
