...
/**
 * Tests for allbookingoptions shortcode.
 *
 * @package mod_booking
 * @category test
...
/**
 * Class handling tests for allbookingoptions.
 *
 * @package mod_booking
 * @category test
 * @copyright 2025 Wunderbyte GmbH <info@wunderbyte.at>
 ...
 *
 */
final class allbookingoptions_test extends booking_advanced_testcase {
    /**
     * Tests set up.
     */
     ...
     */
    public function test_allbookingoptions_shortcode(array $data, array $expected): void {
        global $DB, $CFG;
    ...
    public static function booking_common_settings_provider(): array {
        ...
        return [
            'include_filter_on_customfield_text' => [
                [
                    'args' => [
                        'cfinclude' => 'true',
                        'cmidsetting' => 'first',
            ...
            'include_filter_on_customfield_multi' => [
                [
                    'args' => [
                        'cfinclude' => 'true',
                        'cmidsetting' => 'first',
